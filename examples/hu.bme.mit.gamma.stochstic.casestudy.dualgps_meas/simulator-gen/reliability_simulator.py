	...
	if BUILD:
		...
		for command in commands:
			if os.system(command) == 0:
				...
				print( "ERROR")
				break
	startJVM("""C:\\Program Files\\Java\\jdk-20\\bin\\server\\jvm.dll""", '-ea',"""-Djava.class.path=C:\\Users\\simon\\git\\stochastic-gamma\\examples\\hu.bme.mit.gamma.stochstic.casestudy.dualgps_meas\\bin""")
	detmodel = 0
	EntryPoint = JClass('javaenv.ReliabilityEntryPoint')
	detmodel = EntryPoint()
...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components["System.GPS1_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS1_Failure302")}},
		...
		self.components["System.GPS2_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS2_Failure303")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.GPS3_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS3_Failure304")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.GPS4_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS4_Failure305")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.GPS5_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS5_Failure306")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.GPS6_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS6_Failure307")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.GPS7_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS7_Failure308")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.GPS8_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS8_Failure309")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.Voter_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(20.0)),"ContRandomVarriableVoter_Failure310")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
