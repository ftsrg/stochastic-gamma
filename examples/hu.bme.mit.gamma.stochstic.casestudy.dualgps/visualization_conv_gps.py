...
df = pd.read_csv('measurements/gps_cond_conv_meas_2.csv')
...
fig = make_subplots(
    rows=1, cols=2,
    subplot_titles=("GPS simulation analysis", "GPS importance analysis"), 
...
df_sim = pd.read_csv('measurements/gps_sim_conv_meas_3.csv')
...
if not os.path.exists("images"):
    os.mkdir("images")
fig.write_image("images/gps_conv_meas.svg")
fig.write_image("images/gps_conv_meas.pdf")
