...
df1 = pd.read_csv('measurements/gps_runtime_meas_sim_10e_r5.csv')
df1=df1.groupby("script",as_index=False).median()
df1["method"]="sim."
df1["components"]=df1["script"].map(lambda str1 :int(re.search("\d+", str1).group()))

df2 = pd.read_csv('measurements/gps_runtime_meas_is_10e_r5.csv')
...
if not os.path.exists("images"):
    os.mkdir("images")
fig.write_image("images/gps_scaling_meas_r5.svg")
fig.write_image("images/gps_scaling_meas_r5.pdf")
