		...
		public class ParametricDualGPS_8 implements ParametricDualGPS_8Interface {
			// Component instances
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS5Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS8Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS6Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS7Failure;
			...
			public boolean isEventQueueEmpty(){
				return  GPS1.isEventQueueEmpty()  &&  GPS2.isEventQueueEmpty()  &&  GPS3.isEventQueueEmpty()  &&  GPS4.isEventQueueEmpty()  &&  GPS5.isEventQueueEmpty()  &&  GPS6.isEventQueueEmpty()  &&  GPS7.isEventQueueEmpty()  &&  GPS8.isEventQueueEmpty()  &&  Voter.isEventQueueEmpty()   &&   true &&   true &&   true &&   true &&   true &&   true &&   true &&   true &&   true  ;
			}
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in ParametricDualGPS_8! -----------");
					...
					if (!true){
						System.out.println("    elementary stochastic component GPS5Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS6Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS7Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS8Failure is not empty");
					}
					if (!true){
			...
			public ParametricDualGPS_8(double voterFailureRate) {
...
//
			...
			public boolean isWaiting() {
				return GPS1.isWaiting() && GPS2.isWaiting() && GPS3.isWaiting() && GPS4.isWaiting() && GPS5.isWaiting() && GPS6.isWaiting() && GPS7.isWaiting() && GPS8.isWaiting() && Voter.isWaiting()
					;
			}
