		...
		public class ParametricDualGPS_2 implements ParametricDualGPS_2Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in ParametricDualGPS_2! -----------");
			...
			public ParametricDualGPS_2(double voterFailureRate) {
