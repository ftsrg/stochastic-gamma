		...
		public class ParametricDualGPS_16 implements ParametricDualGPS_16Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in ParametricDualGPS_16! -----------");
			...
			public ParametricDualGPS_16(double voterFailureRate) {
...
//
			...
			public boolean isWaiting() {
				return GPS1_.isWaiting() && GPS2_.isWaiting() && GPS3_.isWaiting() && GPS4_.isWaiting() && GPS5_.isWaiting() && GPS6_.isWaiting() && GPS7_.isWaiting() && GPS8_.isWaiting() && GPS9_.isWaiting() && GPS10.isWaiting() && GPS11.isWaiting() && GPS12.isWaiting() && GPS13.isWaiting() && GPS14.isWaiting() && GPS15.isWaiting() && GPS16.isWaiting() && Voter.isWaiting()
					;
			}
