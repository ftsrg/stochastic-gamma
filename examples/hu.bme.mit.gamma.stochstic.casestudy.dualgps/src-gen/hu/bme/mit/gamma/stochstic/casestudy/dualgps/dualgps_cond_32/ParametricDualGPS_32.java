		...
		public class ParametricDualGPS_32 implements ParametricDualGPS_32Interface {
			// Component instances
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS26Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS23Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS20Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS15Failure;
			private SensorChannelInterface channelCommunicationOfGPS30;
			private SensorChannelInterface channelCommunicationOfGPS15;
			private HardwareFailureChannelInterface channelFaultsOfGPS29Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS17Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS14Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS21Failure;
			private SensorChannelInterface channelCommunicationOfGPS19;
			private HardwareFailureChannelInterface channelFaultsOfGPS30Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS16Failure;
			private SensorChannelInterface channelCommunicationOfGPS31;
			private SensorChannelInterface channelCommunicationOfGPS20;
			private HardwareFailureChannelInterface channelFaultsOfGPS12Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS24Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS22Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS28Failure;
			private SensorChannelInterface channelCommunicationOfGPS1_;
			private HardwareFailureChannelInterface channelFaultsOfGPS31Failure;
			private SensorChannelInterface channelCommunicationOfGPS7_;
			private HardwareFailureChannelInterface channelFaultsOfGPS27Failure;
			private SensorChannelInterface channelCommunicationOfGPS28;
			private HardwareFailureChannelInterface channelFaultsOfGPS10Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS18Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS11Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS2_Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS9_Failure;
			private HardwareFailureChannelInterface channelFaultsOfGPS25Failure;
			private SensorChannelInterface channelCommunicationOfGPS14;
			private HardwareFailureChannelInterface channelFaultsOfGPS13Failure;
			...
			private HardwareFailureChannelInterface channelFaultsOfGPS32Failure;
			private SensorChannelInterface channelCommunicationOfGPS18;
			private HardwareFailureChannelInterface channelFaultsOfGPS19Failure;
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in ParametricDualGPS_32! -----------");
					...
					if (!true){
						System.out.println("    elementary stochastic component GPS9_Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS10Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS11Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS12Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS13Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS14Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS15Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS16Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS17Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS18Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS19Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS20Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS21Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS22Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS23Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS24Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS25Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS26Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS27Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS28Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS29Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS30Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS31Failure is not empty");
					}
					if (!true){
						System.out.println("    elementary stochastic component GPS32Failure is not empty");
					}
					if (!true){
			...
			public ParametricDualGPS_32(double voterFailureRate) {
...
//
			...
			public boolean isWaiting() {
				return GPS1_.isWaiting() && GPS2_.isWaiting() && GPS3_.isWaiting() && GPS4_.isWaiting() && GPS5_.isWaiting() && GPS6_.isWaiting() && GPS7_.isWaiting() && GPS8_.isWaiting() && GPS9_.isWaiting() && GPS10.isWaiting() && GPS11.isWaiting() && GPS12.isWaiting() && GPS13.isWaiting() && GPS14.isWaiting() && GPS15.isWaiting() && GPS16.isWaiting() && GPS17.isWaiting() && GPS18.isWaiting() && GPS19.isWaiting() && GPS20.isWaiting() && GPS21.isWaiting() && GPS22.isWaiting() && GPS23.isWaiting() && GPS24.isWaiting() && GPS25.isWaiting() && GPS26.isWaiting() && GPS27.isWaiting() && GPS28.isWaiting() && GPS29.isWaiting() && GPS30.isWaiting() && GPS31.isWaiting() && GPS32.isWaiting() && Voter.isWaiting()
					;
			}
