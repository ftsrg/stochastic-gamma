...
# time of model generation: 2024-05-11T10:47:11.932732400
...
def create_detmodel():
	...
	detmodel = 0
	EntryPoint = JClass('javaenv.Reliability_Cond_16EntryPoint')
	detmodel = EntryPoint()
...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components["System.Voter_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : RandomVariable(pyro.distributions.Exponential(self.voterFailureRate[0]),"ContRandomVarriableVoter_Failure16")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
...
def guide():
	...
	dists.append[RandomVariable(pyro.distributions.Exponential(self.voterFailureRate[0]),"ContRandomVarriableVoter_Failure16")]
