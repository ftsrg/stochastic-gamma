...
diagram_name_dict = {
	"Reliability::System" : "DualGPS",
	"Reliability::System::GPS1" : "GPSasync",
	"Reliability::System::GPS1::Gps" : "GPS",
	"Reliability::System::GPS2" : "GPSasync",
	"Reliability::System::GPS2::Gps" : "GPS",
	"Reliability::System::Voter" : "Voterasync",
	"Reliability::System::Voter::Voter" : "Voter",
}
...
class MyServer(BaseHTTPRequestHandler):
	...
	def send_page(self):
		...
		if cmd not in config.keys() and cmd!="":
			print("Eval : ","detmodel.get"+cmd.replace("Reliability__","").replace("__","().get")+"().toString()")
			value=str(eval("detmodel.get"+cmd.replace("Reliability__","").replace("__","().get")+"().toString()"))
			...
			for option in config[cmd].keys():
				if option != "dummy":
					...
					if "__STATECHART__" in config[cmd][option]:
						print("Eval : ", "detmodel.get"+cmd.replace("Reliability__","").replace("__","().get")+"().get"+config[cmd][option].replace("__STATECHART__","")+"().toString()")
						value=str(eval("detmodel.get"+cmd.replace("Reliability__","").replace("__","().get")+"().get"+config[cmd][option].replace("__STATECHART__","")+"().toString()"))
						...
						print("Eval : ","detmodel.get"+cmd.replace("Reliability__","").replace("__","().get")+"().get"+config[cmd][option].replace("::","().get")+"()")
						value=str(eval("detmodel.get"+cmd.replace("Reliability__","").replace("__","().get")+"().get"+config[cmd][option].replace("::","().get")+"()"))
						s=""
