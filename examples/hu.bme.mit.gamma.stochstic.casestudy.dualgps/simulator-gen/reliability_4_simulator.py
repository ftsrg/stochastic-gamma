...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components["System.GPS1_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS1_Failure434")}},
		...
		self.components["System.GPS2_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS2_Failure435")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.GPS3_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS3_Failure436")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.GPS4_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS4_Failure437")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.Voter_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(20.0)),"ContRandomVarriableVoter_Failure438")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
