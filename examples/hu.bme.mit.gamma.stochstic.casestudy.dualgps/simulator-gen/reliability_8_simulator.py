...
# time of model generation: 2024-06-06T13:03:02.277689
...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components["System.Voter_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : RandomVariable(pyro.distributions.Exponential(torch.tensor(20.0)),"ContRandomVarriableVoter_Failure8")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
...
def guide():
	...
	dists.append[RandomVariable(pyro.distributions.Exponential(torch.tensor(20.0)),"ContRandomVarriableVoter_Failure8")]
