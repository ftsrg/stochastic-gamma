...
def create_detmodel():
	...
	detmodel = 0
	EntryPoint = JClass('javaenv.Reliability_2EntryPoint')
	detmodel = EntryPoint()
...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components["System.GPS1_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS1_Failure398")}},
		...
		self.components["System.GPS2_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(10.0)),"ContRandomVarriableGPS2_Failure399")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
		...
		self.components["System.Voter_Failure"].configure(
				...
				rules = {'Faults' : {'Failure' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(20.0)),"ContRandomVarriableVoter_Failure400")}},
				portevents = 	{	"Faults" : [ "Failure"	]},
				simulator=self)
