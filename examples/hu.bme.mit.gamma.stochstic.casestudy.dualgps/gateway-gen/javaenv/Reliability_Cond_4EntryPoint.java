...
import hu.bme.mit.gamma.stochstic.casestudy.dualgps.dualgps_cond_4.ParametricDualGPS_4;
...
public class Reliability_Cond_4EntryPoint  {
	
	public ParametricDualGPS_4 detModel=new ParametricDualGPS_4(0.0
	);
	...
	public Reliability_Cond_4EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new ParametricDualGPS_4(voterFailureRate
		);
		detModel.getCommunication().registerListener(monitorOfAspectSystem_Communication_Failstop);
		detModel.getCommunication().registerListener(monitorOfConditionSystem_Communication_Failstop);
		detModel.getCommunication().registerListener(monitorOfEndConditionSystem_Communication_Failstop);
	...
	public ParametricDualGPS_4 getDetModel(){
		return detModel;
	}
	
	public ParametricDualGPS_4 getSystem(){
		return detModel;
	}   
