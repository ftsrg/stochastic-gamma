...
import hu.bme.mit.gamma.stochstic.casestudy.dualgps.dualgps_cond_16.ParametricDualGPS_16;
...
public class Reliability_Cond_16EntryPoint  {
	
	public ParametricDualGPS_16 detModel=new ParametricDualGPS_16(0.0
	);
	...
	public Reliability_Cond_16EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new ParametricDualGPS_16(voterFailureRate
		);
		detModel.getCommunication().registerListener(monitorOfAspectSystem_Communication_Failstop);
		detModel.getCommunication().registerListener(monitorOfConditionSystem_Communication_Failstop);
		detModel.getCommunication().registerListener(monitorOfEndConditionSystem_Communication_Failstop);
	...
	public ParametricDualGPS_16 getDetModel(){
		return detModel;
	}
	
	public ParametricDualGPS_16 getSystem(){
		return detModel;
	}   
