...
import hu.bme.mit.gamma.stochstic.casestudy.dualgps.dualgps_8.DualGPS_8;
...
public class Reliability_8EntryPoint  {
	
	public DualGPS_8 detModel=new DualGPS_8();
	...
	public Reliability_8EntryPoint(){
	...
	public DualGPS_8 getDetModel(){
		return detModel;
	}
	
	public DualGPS_8 getSystem(){
		return detModel;
	}   
