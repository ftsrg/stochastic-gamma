...
import hu.bme.mit.gamma.stochstic.casestudy.dualgps.dualgps_cond_2.ParametricDualGPS_2;
...
public class Reliability_Cond_2EntryPoint  {
	
	public ParametricDualGPS_2 detModel=new ParametricDualGPS_2(0.0
	);
	...
	public Reliability_Cond_2EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new ParametricDualGPS_2(voterFailureRate
		);
		detModel.getCommunication().registerListener(monitorOfAspectSystem_Communication_Failstop);
		detModel.getCommunication().registerListener(monitorOfConditionSystem_Communication_Failstop);
		detModel.getCommunication().registerListener(monitorOfEndConditionSystem_Communication_Failstop);
	...
	public ParametricDualGPS_2 getDetModel(){
		return detModel;
	}
	
	public ParametricDualGPS_2 getSystem(){
		return detModel;
	}   
