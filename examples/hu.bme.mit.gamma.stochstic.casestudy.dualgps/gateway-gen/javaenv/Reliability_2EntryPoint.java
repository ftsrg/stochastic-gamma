...
import hu.bme.mit.gamma.stochstic.casestudy.dualgps.dualgps_2.DualGPS_2;
...
public class Reliability_2EntryPoint  {
	
	public DualGPS_2 detModel=new DualGPS_2();
	...
	public Reliability_2EntryPoint(){
	...
	public DualGPS_2 getDetModel(){
		return detModel;
	}
	
	public DualGPS_2 getSystem(){
		return detModel;
	}   
