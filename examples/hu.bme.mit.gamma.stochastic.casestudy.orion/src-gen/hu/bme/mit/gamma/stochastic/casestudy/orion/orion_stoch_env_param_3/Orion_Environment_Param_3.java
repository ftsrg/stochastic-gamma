		...
		public class Orion_Environment_Param_3 implements Orion_Environment_Param_3Interface {
			// Component instances
			...
			private final double timerJitter;
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in Orion_Environment_Param_3! -----------");
			...
			public Orion_Environment_Param_3(double timerJitter) {
