...
public class Orion_Master_SMStatemachine {
	...
	public void setClosedTimeout(int ClosedTimeout) {
		this.ClosedTimeout = ClosedTimeout;
	}
	
	public int getClosedTimeout() {
	...
	private void changeState() {
		if ((((this.main_region_1 == Main_region_1.Closed)) && ((5000 <= this.ClosedTimeout)))) {
			this.Send_StateMachine_Port_OrionConnReq_Out = true;
			this.main_region_1 = Main_region_1.Connecting;
		}
		else {
			if ((((this.main_region_1 == Main_region_1.Connecting)) && (this.StateMachine_Port_OrionConnResp_In))) {
	...
	public String toString() {
		return
			...
			"sendRegion = " + sendRegion + System.lineSeparator() +
