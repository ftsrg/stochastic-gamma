		...
		public class OrionBenchMarkSystem_4 implements OrionBenchMarkSystem_4Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in OrionBenchMarkSystem_4! -----------");
