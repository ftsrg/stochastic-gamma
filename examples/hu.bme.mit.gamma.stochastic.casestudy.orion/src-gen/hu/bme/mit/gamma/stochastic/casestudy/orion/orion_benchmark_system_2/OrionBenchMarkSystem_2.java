		...
		public class OrionBenchMarkSystem_2 implements OrionBenchMarkSystem_2Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in OrionBenchMarkSystem_2! -----------");
