...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_slave_sm2.Orion_Slave_SMStatemachine.*;
...
public Orion_Slave_SMStatemachine getOrion_Slave_SM(){
	...
	public boolean isStateActive(String region, String state) {
		switch (region) {
			case "main_region_1":
				return orion_Slave_SM.getMain_region_1() == Main_region_1.valueOf(state);
			case "SendRegion":
				return orion_Slave_SM.getSendRegion() == SendRegion.valueOf(state);
			case "RecieveRegion":
				return orion_Slave_SM.getRecieveRegion() == RecieveRegion.valueOf(state);
		}
		return false;
	}
