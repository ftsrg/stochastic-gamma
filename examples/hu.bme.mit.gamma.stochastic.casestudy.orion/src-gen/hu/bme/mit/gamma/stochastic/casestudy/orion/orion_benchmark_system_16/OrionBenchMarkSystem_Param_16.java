		...
		public class OrionBenchMarkSystem_Param_16 implements OrionBenchMarkSystem_Param_16Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in OrionBenchMarkSystem_Param_16! -----------");
			...
			public OrionBenchMarkSystem_Param_16(double timerMean) {
