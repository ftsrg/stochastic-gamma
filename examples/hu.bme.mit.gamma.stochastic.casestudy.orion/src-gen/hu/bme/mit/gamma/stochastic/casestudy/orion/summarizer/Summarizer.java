...
import hu.bme.mit.gamma.stochastic.casestudy.orion.summarizer.SummarizerStatemachine.*;

public class Summarizer implements SummarizerInterface, TimedObject{
	// Port instances
...
public SummarizerStatemachine getSummarizer(){
	return summarizer;
}
