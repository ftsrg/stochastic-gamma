...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_slave_sm_ext.Orion_Slave_SM_extStatemachine.*;

public class Orion_Slave_SM_ext implements Orion_Slave_SM_extInterface, TimedObject{
	// Port instances
	...
	public void resetVariables() {
		orion_Slave_SM_ext.resetVariables();
	}

	public void resetStateConfigurations() {
		orion_Slave_SM_ext.resetStateConfigurations();
	}

	public void raiseEntryEvents() {
		orion_Slave_SM_ext.raiseEntryEvents();
	}
	...
	public class TimeoutKeepAliveReceiveTimeout_4_req implements SoftwareTimerInterface.Provided {
		...
		public boolean isRaisedNewEvent() {
			return orion_Slave_SM_ext.getTimeoutKeepAliveReceiveTimeout_4_req_newEvent_Out();
		}
		@Override
	...
	public class TimeoutKapcsolodik_3_req implements SoftwareTimerInterface.Provided {
		...
		@Override
		public boolean isRaisedNewEvent() {
			return orion_Slave_SM_ext.getTimeoutKapcsolodik_3_req_newEvent_Out();
		}
		@Override
		public void registerListener(SoftwareTimerInterface.Listener.Provided listener) {
			listeners.add(listener);
	...
	public class TimeoutKeepAliveSendTimeout_0_req implements SoftwareTimerInterface.Provided {
		...
		@Override
		public boolean isRaisedNewEvent() {
			return orion_Slave_SM_ext.getTimeoutKeepAliveSendTimeout_0_req_newEvent_Out();
		}
		@Override
		public void registerListener(SoftwareTimerInterface.Listener.Provided listener) {
			listeners.add(listener);
...
public Orion_Slave_SM_extStatemachine getOrion_Slave_SM_ext(){
	return orion_Slave_SM_ext;
}
	...
	public void notifyListeners() {
		...
		if (timeoutKeepAliveReceiveTimeout_4_req.isRaisedNewEvent()) {
			for (SoftwareTimerInterface.Listener.Provided listener : timeoutKeepAliveReceiveTimeout_4_req.getRegisteredListeners()) {
				listener.raiseNewEvent();
			}
		}
		if (timeoutKapcsolodik_3_req.isRaisedNewEvent()) {
			for (SoftwareTimerInterface.Listener.Provided listener : timeoutKapcsolodik_3_req.getRegisteredListeners()) {
				listener.raiseNewEvent();
			}
		}
		if (timeoutKeepAliveSendTimeout_0_req.isRaisedNewEvent()) {
			for (SoftwareTimerInterface.Listener.Provided listener : timeoutKeepAliveSendTimeout_0_req.getRegisteredListeners()) {
				listener.raiseNewEvent();
			}
		}
	...
	public String toString() {
		String str=orion_Slave_SM_ext.toString();
		str=str+"\n "+getInQueue();
		return str;
	}
