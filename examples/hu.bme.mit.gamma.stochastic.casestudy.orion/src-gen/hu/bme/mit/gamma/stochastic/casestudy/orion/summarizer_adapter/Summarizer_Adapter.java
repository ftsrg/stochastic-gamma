...
public class Summarizer_Adapter implements Runnable, Summarizer_AdapterInterface {			
	...
	public void handleBeforeReset() {
		//interrupt();
		//
		summarizerComp.handleBeforeReset();
	}
	
	public void resetVariables() {
		summarizerComp.resetVariables();
	}
	
	public void resetStateConfigurations() {
		summarizerComp.resetStateConfigurations();
	}
	
	public void raiseEntryEvents() {
		summarizerComp.raiseEntryEvents();
	}
	
	public void handleAfterReset() {
		summarizerComp.handleAfterReset();
		//
	}
