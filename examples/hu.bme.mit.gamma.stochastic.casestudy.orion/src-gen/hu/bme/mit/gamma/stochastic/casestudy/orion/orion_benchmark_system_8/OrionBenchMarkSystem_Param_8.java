		...
		public class OrionBenchMarkSystem_Param_8 implements OrionBenchMarkSystem_Param_8Interface {
			// Component instances
			...
			public boolean isEventQueueEmpty(){
				return  subSystem1_.isEventQueueEmpty()  &&  subSystem2_.isEventQueueEmpty()  &&  subSystem3_.isEventQueueEmpty()  &&  subSystem4_.isEventQueueEmpty()  &&  summarizer.isEventQueueEmpty()     ;
			}
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in OrionBenchMarkSystem_Param_8! -----------");
			...
			public OrionBenchMarkSystem_Param_8(double timerMean) {
...
//
			...
			public boolean isWaiting() {
				return subSystem1_.isWaiting() && subSystem2_.isWaiting() && subSystem3_.isWaiting() && subSystem4_.isWaiting() && summarizer.isWaiting()
					;
			}
