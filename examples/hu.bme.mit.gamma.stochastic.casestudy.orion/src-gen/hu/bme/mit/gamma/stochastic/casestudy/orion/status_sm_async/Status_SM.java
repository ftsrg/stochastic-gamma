package hu.bme.mit.gamma.stochastic.casestudy.orion.status_sm_async;
...
import hu.bme.mit.gamma.stochastic.casestudy.orion.status_sm_async.Status_SMStatemachine.*;

public class Status_SM implements Status_SMInterface, TimedObject{
	// Port instances
	...
	public void resetVariables() {
		status_SM.resetVariables();
	}

	public void resetStateConfigurations() {
		status_SM.resetStateConfigurations();
	}

	public void raiseEntryEvents() {
		status_SM.raiseEntryEvents();
	}
...
public Status_SMStatemachine getStatus_SM(){
	return status_SM;
}
