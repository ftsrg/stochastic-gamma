		...
		public class OrionBenchMarkSystem_16 implements OrionBenchMarkSystem_16Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in OrionBenchMarkSystem_16! -----------");
			...
			public OrionBenchMarkSystem_16() {
