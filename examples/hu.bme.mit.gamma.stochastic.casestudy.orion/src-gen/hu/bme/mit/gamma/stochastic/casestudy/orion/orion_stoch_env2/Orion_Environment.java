		package hu.bme.mit.gamma.stochastic.casestudy.orion.orion_stoch_env2;
		...
		import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_adapter3.*;
		...
		public class Orion_Environment implements Orion_EnvironmentInterface {
			...
			// Channel instances
			private TimingChannelInterface channelTimingOfSoftwareTimer;
			...
			public boolean isEventQueueEmpty(){
				return  orionSystem.isEventQueueEmpty()   &&   true  ;
			}
			...
			public Orion_Environment(UnifiedTimerInterface timer) {
