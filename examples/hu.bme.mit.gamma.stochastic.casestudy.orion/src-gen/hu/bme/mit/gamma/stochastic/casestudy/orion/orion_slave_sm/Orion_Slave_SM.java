...
public class Orion_Slave_SM implements Orion_Slave_SMInterface, TimedObject{
	// Port instances
	...
	public void resetVariables() {
		orion_Slave_SM.resetVariables();
	}

	public void resetStateConfigurations() {
		orion_Slave_SM.resetStateConfigurations();
	}

	public void raiseEntryEvents() {
		orion_Slave_SM.raiseEntryEvents();
	}
	...
	public class Status implements ConnectionStateInterface.Provided {
		...
		public boolean isRaisedConn() {
			return orion_Slave_SM.getStatus_conn_Out();
		}
		@Override
		public boolean isRaisedDisconn() {
			return orion_Slave_SM.getStatus_disconn_Out();
		}
		@Override
...
public Orion_Slave_SMStatemachine getOrion_Slave_SM(){
	return orion_Slave_SM;
}
	...
	public long getEarliestTime(){
		...
		long TimeoutKeepAliveReceiveTimeout_4Limit=5000;
		long TimeoutKeepAliveReceiveTimeout_4Time= orion_Slave_SM.getTimeoutKeepAliveReceiveTimeout_4()+elapsedTime;
		long TimeoutKeepAliveReceiveTimeout_4RemainingTime=TimeoutKeepAliveReceiveTimeout_4Limit-TimeoutKeepAliveReceiveTimeout_4Time;
		if ( (TimeoutKeepAliveReceiveTimeout_4Time>=0) 
			&& (TimeoutKeepAliveReceiveTimeout_4RemainingTime > 0)
			&& (TimeoutKeepAliveReceiveTimeout_4RemainingTime<earliestTime) ) {
			earliestTime=TimeoutKeepAliveReceiveTimeout_4RemainingTime;
		}
		long TimeoutKapcsolodik_3Limit=5000;
		long TimeoutKapcsolodik_3Time= orion_Slave_SM.getTimeoutKapcsolodik_3()+elapsedTime;
		long TimeoutKapcsolodik_3RemainingTime=TimeoutKapcsolodik_3Limit-TimeoutKapcsolodik_3Time;
		if ( (TimeoutKapcsolodik_3Time>=0) 
			&& (TimeoutKapcsolodik_3RemainingTime > 0)
			&& (TimeoutKapcsolodik_3RemainingTime<earliestTime) ) {
			earliestTime=TimeoutKapcsolodik_3RemainingTime;
		}
		long TimeoutKeepAliveSendTimeout_0Limit=4000;
		long TimeoutKeepAliveSendTimeout_0Time= orion_Slave_SM.getTimeoutKeepAliveSendTimeout_0()+elapsedTime;
		long TimeoutKeepAliveSendTimeout_0RemainingTime=TimeoutKeepAliveSendTimeout_0Limit-TimeoutKeepAliveSendTimeout_0Time;
		if ( (TimeoutKeepAliveSendTimeout_0Time>=0) 
			&& (TimeoutKeepAliveSendTimeout_0RemainingTime > 0)
			&& (TimeoutKeepAliveSendTimeout_0RemainingTime<earliestTime) ) {
			earliestTime=TimeoutKeepAliveSendTimeout_0RemainingTime;
		}
		return earliestTime;
	}
	...
	public String toString() {
		String str=orion_Slave_SM.toString();
		str=str+"\n "+getInQueue();
		return str;
	}
