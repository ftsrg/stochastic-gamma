		...
		public class OrionBenchMarkSystem_Param_4 implements OrionBenchMarkSystem_Param_4Interface {
			// Component instances
			...
			public boolean isEventQueueEmpty(){
				return  subSystem1_.isEventQueueEmpty()  &&  subSystem2_.isEventQueueEmpty()  &&  summarizer.isEventQueueEmpty()     ;
			}
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in OrionBenchMarkSystem_Param_4! -----------");
			...
			public OrionBenchMarkSystem_Param_4(double timerMean) {
...
//
			...
			public boolean isWaiting() {
				return subSystem1_.isWaiting() && subSystem2_.isWaiting() && summarizer.isWaiting()
					;
			}
