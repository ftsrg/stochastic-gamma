...
public class ChannelStatechartStatemachine {
	...
	private void changeState() {
		if ((((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)) && (this.Input_OrionDisconn_In))) {
			this.Output_OrionDisconn_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		} else 
		if ((((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)) && (this.Input_OrionDisconnCause_In))) {
			this.Output_OrionDisconnCause_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		} else 
		if ((((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)) && (this.Input_OrionConnReq_In))) {
			this.Output_OrionConnReq_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		} else 
		if ((((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)) && (this.Input_OrionAppData_In))) {
			this.Output_OrionAppData_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		} else 
		if ((((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)) && (this.Input_OrionKeepAlive_In))) {
			this.Output_OrionKeepAlive_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		} else 
		if ((((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)) && (this.Input_OrionConnConf_In))) {
			this.Output_OrionConnConf_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		} else 
		if ((((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)) && (this.Input_OrionConnResp_In))) {
