...
from orion_performance_cond_simulator import *
import pyro
import math
import csv
...
filename = "measurements/orion_cond_conv_meas_2.csv"

def model():
    result=simulate()
    #pyro.sample("cond",dist.Normal(torch.tensor(16.0),torch.tensor(1.00)),obs=torch.tensor(result))
