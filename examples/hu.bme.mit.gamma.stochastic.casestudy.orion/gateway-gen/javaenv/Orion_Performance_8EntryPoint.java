...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_benchmark_system_8.OrionBenchMarkSystem_8;
...
public class Orion_Performance_8EntryPoint  {
	
	public OrionBenchMarkSystem_8 detModel=new OrionBenchMarkSystem_8();
	...
	public Orion_Performance_8EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new OrionBenchMarkSystem_8();
		detModel.getSystemConnStatus().registerListener(monitorOfAspectOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfEndConditionOrion_SystemConnStatus_Conn);
		*/
	...
	public OrionBenchMarkSystem_8 getDetModel(){
		return detModel;
	}
	
	public OrionBenchMarkSystem_8 getOrion(){
		return detModel;
	}   
