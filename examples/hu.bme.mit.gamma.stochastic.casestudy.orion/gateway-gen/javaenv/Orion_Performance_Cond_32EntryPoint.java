...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_benchmark_system_32.OrionBenchMarkSystem_Param_32;
...
public class Orion_Performance_Cond_32EntryPoint  {
	
	public OrionBenchMarkSystem_Param_32 detModel=new OrionBenchMarkSystem_Param_32(0.0
	);
	...
	public Orion_Performance_Cond_32EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new OrionBenchMarkSystem_Param_32(timerMean
		);
		detModel.getSystemConnStatus().registerListener(monitorOfAspectOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfConditionOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfEndConditionOrion_SystemConnStatus_Conn);
	...
	public OrionBenchMarkSystem_Param_32 getDetModel(){
		return detModel;
	}
	
	public OrionBenchMarkSystem_Param_32 getOrion(){
		return detModel;
	}   
