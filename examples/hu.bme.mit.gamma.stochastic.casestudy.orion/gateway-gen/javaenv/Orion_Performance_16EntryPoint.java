...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_benchmark_system_16.OrionBenchMarkSystem_16;
...
public class Orion_Performance_16EntryPoint  {
	
	public OrionBenchMarkSystem_16 detModel=new OrionBenchMarkSystem_16();
	...
	public Orion_Performance_16EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new OrionBenchMarkSystem_16();
		detModel.getSystemConnStatus().registerListener(monitorOfAspectOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfEndConditionOrion_SystemConnStatus_Conn);
		*/
	...
	public OrionBenchMarkSystem_16 getDetModel(){
		return detModel;
	}
	
	public OrionBenchMarkSystem_16 getOrion(){
		return detModel;
	}   
