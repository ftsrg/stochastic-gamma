...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_benchmark_system_32.OrionBenchMarkSystem_32;
...
public class Orion_Performance_32EntryPoint  {
	
	public OrionBenchMarkSystem_32 detModel=new OrionBenchMarkSystem_32();
	...
	public Orion_Performance_32EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new OrionBenchMarkSystem_32();
		detModel.getSystemConnStatus().registerListener(monitorOfAspectOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfEndConditionOrion_SystemConnStatus_Conn);
		*/
	...
	public OrionBenchMarkSystem_32 getDetModel(){
		return detModel;
	}
	
	public OrionBenchMarkSystem_32 getOrion(){
		return detModel;
	}   
