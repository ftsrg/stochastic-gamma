...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_benchmark_system_8.OrionBenchMarkSystem_Param_8;
...
public class Orion_Performance_Cond_8EntryPoint  {
	
	public OrionBenchMarkSystem_Param_8 detModel=new OrionBenchMarkSystem_Param_8(0.0
	);
	...
	public Orion_Performance_Cond_8EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new OrionBenchMarkSystem_Param_8(timerMean
		);
		detModel.getSystemConnStatus().registerListener(monitorOfAspectOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfConditionOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfEndConditionOrion_SystemConnStatus_Conn);
	...
	public OrionBenchMarkSystem_Param_8 getDetModel(){
		return detModel;
	}
	
	public OrionBenchMarkSystem_Param_8 getOrion(){
		return detModel;
	}   
