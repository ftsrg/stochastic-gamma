...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_benchmark_system_2.OrionBenchMarkSystem_2;
...
public class Orion_Performance_2EntryPoint  {
	
	public OrionBenchMarkSystem_2 detModel=new OrionBenchMarkSystem_2();
	...
	public Orion_Performance_2EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new OrionBenchMarkSystem_2();
		detModel.getSystemConnStatus().registerListener(monitorOfAspectOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfEndConditionOrion_SystemConnStatus_Conn);
		*/
	...
	public OrionBenchMarkSystem_2 getDetModel(){
		return detModel;
	}
	
	public OrionBenchMarkSystem_2 getOrion(){
		return detModel;
	}   
