...
import hu.bme.mit.gamma.stochastic.casestudy.orion.orion_benchmark_system_4.OrionBenchMarkSystem_Param_4;
...
public class Orion_Performance_Cond_4EntryPoint  {
	
	public OrionBenchMarkSystem_Param_4 detModel=new OrionBenchMarkSystem_Param_4(0.0
	);
	...
	public Orion_Performance_Cond_4EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new OrionBenchMarkSystem_Param_4(timerMean
		);
		detModel.getSystemConnStatus().registerListener(monitorOfAspectOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfConditionOrion_SystemConnStatus_Conn);
		detModel.getSystemConnStatus().registerListener(monitorOfEndConditionOrion_SystemConnStatus_Conn);
	...
	public OrionBenchMarkSystem_Param_4 getDetModel(){
		return detModel;
	}
	
	public OrionBenchMarkSystem_Param_4 getOrion(){
		return detModel;
	}   
