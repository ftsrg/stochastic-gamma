...
if2 = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.interfaces.SoftwareTimerInterface$Listener$Provided')
if2_s = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.scheduling.ElementaryComponentSchedulingInterface')
...
if3 = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.interfaces.StateMachine_Interface_For_OrionInterface$Listener$Provided')
...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components[".Orion()DelayKeepAliveReceiveTimeout_3"].configure(
				...
				rules = {'TimoeutKeepAliveReceiveTimeout_3' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableDelayKeepAliveReceiveTimeout_318")}},
				simulator=self)
		...
		self.components[".Orion()DelayKapcsolodik_2"].configure(
				...
				rules = {'TimeoutKapcsolodik_2' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableDelayKapcsolodik_219")}},
				simulator=self)
		...
		self.components[".Orion()DelayZarva_0"].configure(
				...
				rules = {'TimeoutZarva_0' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableDelayZarva_020")}},
				simulator=self)
		...
		self.components[".Orion()DelayKeepAliveSendTimeout_1"].configure(
				...
				rules = {'TimeoutKeepAliveSendTimeout_1' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableDelayKeepAliveSendTimeout_121")}},
				simulator=self)
		...
		self.components[".Orion()DelayKeepAliveReceiveTimeout_4"].configure(
				...
				rules = {'TimeoutKeepAliveReceiveTimeout_4' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableDelayKeepAliveReceiveTimeout_422")}},
				simulator=self)
		...
		self.components[".Orion()DelayKapcsolodik_3"].configure(
				...
				rules = {'TimeoutKapcsolodik_3' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableDelayKapcsolodik_323")}},
				simulator=self)
		...
		self.components[".Orion()DelayKeepAliveSendTimeout_0"].configure(
				...
				rules = {'TimeoutKeepAliveSendTimeout_0' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableDelayKeepAliveSendTimeout_024")}},
				simulator=self)
