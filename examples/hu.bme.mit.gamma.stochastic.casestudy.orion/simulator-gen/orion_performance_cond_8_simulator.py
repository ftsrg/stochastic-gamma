...
# time of model generation: 2024-05-11T09:20:17.025450500
...
def create_detmodel():
	...
	detmodel = 0
	EntryPoint = JClass('javaenv.Orion_Performance_Cond_8EntryPoint')
	detmodel = EntryPoint()
...
if169 = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.interfaces.StateMachine_Interface_For_OrionInterface$Listener$Provided')
if169_s = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.scheduling.ElementaryComponentSchedulingInterface')

@JImplements([if169,if169_s])
