...
if15 = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.interfaces.SoftwareTimerInterface$Listener$Provided')
if15_s = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.scheduling.ElementaryComponentSchedulingInterface')
...
if16 = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.interfaces.StateMachine_Interface_For_OrionInterface$Listener$Provided')
if16_s = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.scheduling.ElementaryComponentSchedulingInterface')
...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components["Orion.DelayKeepAliveReceiveTimeout_3"].configure(
				...
				rules = {'TimoeutKeepAliveReceiveTimeout_3' : {'NewEvent' : RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKeepAliveReceiveTimeout_30")}},
				simulator=self)
		...
		self.components["Orion.DelayKapcsolodik_2"].configure(
				...
				rules = {'TimeoutKapcsolodik_2' : {'NewEvent' : RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKapcsolodik_21")}},
				simulator=self)
		...
		self.components["Orion.DelayZarva_0"].configure(
				...
				rules = {'TimeoutZarva_0' : {'NewEvent' : RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayZarva_02")}},
				simulator=self)
		...
		self.components["Orion.DelayKeepAliveSendTimeout_1"].configure(
				...
				rules = {'TimeoutKeepAliveSendTimeout_1' : {'NewEvent' : RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKeepAliveSendTimeout_13")}},
				simulator=self)
		...
		self.components["Orion.DelayKeepAliveReceiveTimeout_4"].configure(
				...
				rules = {'TimeoutKeepAliveReceiveTimeout_4' : {'NewEvent' : RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKeepAliveReceiveTimeout_44")}},
				simulator=self)
		...
		self.components["Orion.DelayKapcsolodik_3"].configure(
				...
				rules = {'TimeoutKapcsolodik_3' : {'NewEvent' : RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKapcsolodik_35")}},
				simulator=self)
		...
		self.components["Orion.DelayKeepAliveSendTimeout_0"].configure(
				...
				rules = {'TimeoutKeepAliveSendTimeout_0' : {'NewEvent' : RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKeepAliveSendTimeout_06")}},
				simulator=self)
...
def guide():
	...
	dists.append[RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKeepAliveReceiveTimeout_30")]
	dists.append[RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKapcsolodik_21")]
	dists.append[RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayZarva_02")]
	dists.append[RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKeepAliveSendTimeout_13")]
	dists.append[RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKeepAliveReceiveTimeout_44")]
	dists.append[RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKapcsolodik_35")]
	dists.append[RandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.01)),"ContRandomVarriableDelayKeepAliveSendTimeout_06")]
