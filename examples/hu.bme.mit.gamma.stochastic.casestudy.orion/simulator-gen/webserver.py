...
diagram_name_dict = {
	"Orion_Performance::Orion" : "Orion_Environment",
	"Orion_Performance::Orion::OrionSystem" : "OrionStochSystem",
	"Orion_Performance::Orion::OrionSystem::ConnStatus" : "Status_SM",
	"Orion_Performance::Orion::OrionSystem::Master" : "Orion_Master_Adapter",
	"Orion_Performance::Orion::OrionSystem::Master::Master" : "Orion_Master_SM_ext",
	"Orion_Performance::Orion::OrionSystem::Slave" : "Orion_Slave_Adapter",
	"Orion_Performance::Orion::OrionSystem::Slave::Slave" : "Orion_Slave_SM_ext",
}
...
class MyServer(BaseHTTPRequestHandler):
	...
	def send_page(self):
		...
		self.wfile.write(bytes("""<li>""", "utf-8"))
		self.wfile.write(bytes("""EndConditionOrion_SystemConnStatus_Conn : """+ str(detmodel.monitorOfEndConditionOrion_SystemConnStatus_Conn.state), "utf-8"))
		self.wfile.write(bytes("""</li>""", "utf-8"))
		...
		self.wfile.write(bytes("""<li>""", "utf-8"))
		self.wfile.write(bytes("""SystemConnStatus_conn_mt : """+ str(stochmodel.time), "utf-8"))
		self.wfile.write(bytes("""</li>""", "utf-8"))
		...
		if cmd not in config.keys() and cmd!="":
			print("Eval : ","detmodel.get"+cmd.replace("Orion_Performance__","").replace("__","().get")+"().toString()")
			value=str(eval("detmodel.get"+cmd.replace("Orion_Performance__","").replace("__","().get")+"().toString()"))
			...
			for option in config[cmd].keys():
				if option != "dummy":
					...
					if "__STATECHART__" in config[cmd][option]:
						print("Eval : ", "detmodel.get"+cmd.replace("Orion_Performance__","").replace("__","().get")+"().get"+config[cmd][option].replace("__STATECHART__","")+"().toString()")
						value=str(eval("detmodel.get"+cmd.replace("Orion_Performance__","").replace("__","().get")+"().get"+config[cmd][option].replace("__STATECHART__","")+"().toString()"))
						...
						print("Eval : ","detmodel.get"+cmd.replace("Orion_Performance__","").replace("__","().get")+"().get"+config[cmd][option].replace("::","().get")+"()")
						value=str(eval("detmodel.get"+cmd.replace("Orion_Performance__","").replace("__","().get")+"().get"+config[cmd][option].replace("::","().get")+"()"))
						s=":"
