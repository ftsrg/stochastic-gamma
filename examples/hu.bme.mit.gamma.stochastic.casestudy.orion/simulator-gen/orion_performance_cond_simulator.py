...
# time of model generation: 2024-05-10T02:26:04.757660600
...
def create_detmodel():
	...
	detmodel = 0
	EntryPoint = JClass('javaenv.Orion_Performance_CondEntryPoint')
	detmodel = EntryPoint()
...
if112 = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.interfaces.StateMachine_Interface_For_OrionInterface$Listener$Provided')
if112_s = JClass('hu.bme.mit.gamma.stochastic.casestudy.orion.scheduling.ElementaryComponentSchedulingInterface')

@JImplements([if112,if112_s])
