...
diagram_name_dict = {
	"ServiceAvailability::System" : "IoTSystem",
	"ServiceAvailability::System::Camera1" : "CameraComponent",
	"ServiceAvailability::System::Camera1::Software" : "CameraAdapter",
	"ServiceAvailability::System::Camera1::Software::CameraSoftware" : "CameraSoftware",
	"ServiceAvailability::System::Camera1::Software::CameraSoftware::CameraDriver" : "CameraDriver",
	"ServiceAvailability::System::Camera1::Software::CameraSoftware::CameraControl" : "CameraControl",
	"ServiceAvailability::System::Camera1::NetworkQueue" : "NetworkAdapter",
	"ServiceAvailability::System::Camera1::NetworkQueue::Network" : "Network",
	"ServiceAvailability::System::Camera2" : "CameraComponent",
	"ServiceAvailability::System::Camera2::Software" : "CameraAdapter",
	"ServiceAvailability::System::Camera2::Software::CameraSoftware" : "CameraSoftware",
	"ServiceAvailability::System::Camera2::Software::CameraSoftware::CameraDriver" : "CameraDriver",
	"ServiceAvailability::System::Camera2::Software::CameraSoftware::CameraControl" : "CameraControl",
	"ServiceAvailability::System::Camera2::NetworkQueue" : "NetworkAdapter",
	"ServiceAvailability::System::Camera2::NetworkQueue::Network" : "Network",
	"ServiceAvailability::System::Edge" : "EdgeAdapter",
	"ServiceAvailability::System::Edge::Edge" : "Edge",
	"ServiceAvailability::System::Traffic" : "RoadTraffic",
	"ServiceAvailability::System::Traffic::TrafficSct" : "TrafficAdapter",
	"ServiceAvailability::System::Traffic::TrafficSct::TrafficAdapter" : "TrafficStatechart",
}
...
class MyServer(BaseHTTPRequestHandler):
	...
	def send_page(self):
		...
		if cmd not in config.keys() and cmd!="":
			print("Eval : ","detmodel.get"+cmd.replace("ServiceAvailability__","").replace("__","().get")+"().toString()")
			value=str(eval("detmodel.get"+cmd.replace("ServiceAvailability__","").replace("__","().get")+"().toString()"))
			...
			for option in config[cmd].keys():
				if option != "dummy":
					...
					if "__STATECHART__" in config[cmd][option]:
						print("Eval : ", "detmodel.get"+cmd.replace("ServiceAvailability__","").replace("__","().get")+"().get"+config[cmd][option].replace("__STATECHART__","")+"().toString()")
						value=str(eval("detmodel.get"+cmd.replace("ServiceAvailability__","").replace("__","().get")+"().get"+config[cmd][option].replace("__STATECHART__","")+"().toString()"))
						...
						print("Eval : ","detmodel.get"+cmd.replace("ServiceAvailability__","").replace("__","().get")+"().get"+config[cmd][option].replace("::","().get")+"()")
						value=str(eval("detmodel.get"+cmd.replace("ServiceAvailability__","").replace("__","().get")+"().get"+config[cmd][option].replace("::","().get")+"()"))
						s=""
