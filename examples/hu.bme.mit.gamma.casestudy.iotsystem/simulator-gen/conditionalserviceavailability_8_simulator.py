...
# time of model generation: 2024-05-10T21:24:53.938497600
...
def create_detmodel():
	...
	detmodel = 0
	EntryPoint = JClass('javaenv.ConditionalServiceAvailability_8EntryPoint')
	detmodel = EntryPoint()
...
if145 = JClass('hu.bme.mit.gamma.casestudy.iotsystem.interfaces.EventStreamInterface$Listener$Provided')
if145_s = JClass('hu.bme.mit.gamma.casestudy.iotsystem.scheduling.ElementaryComponentSchedulingInterface')

@JImplements([if145,if145_s])
...
if146 = JClass('hu.bme.mit.gamma.casestudy.iotsystem.interfaces.DataStreamInterface$Listener$Provided')
if146_s = JClass('hu.bme.mit.gamma.casestudy.iotsystem.scheduling.ElementaryComponentSchedulingInterface')

@JImplements([if146,if146_s])
...
if147 = JClass('hu.bme.mit.gamma.casestudy.iotsystem.interfaces.DataStreamInterface$Listener$Provided')
if147_s = JClass('hu.bme.mit.gamma.casestudy.iotsystem.scheduling.ElementaryComponentSchedulingInterface')

@JImplements([if147,if147_s])
class SampleImageBlur():
	...
	def raiseNewData(self,blurred, car):
		...
		#hu.bme.mit.gamma.expression.model.impl.DecimalTypeDefinitionImpl@69155cf3
		self.event_cntr=self.event_cntr+1
...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components["System.Traffic.carDelay"].configure(
				...
				rules = {'CarOut' : {'NewEvent' : RandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.5),scale=torch.tensor(0.1)),"ContRandomVarriablecarDelay9")}},
				simulator=self)
		...
		self.components["System.Camera1.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur18")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera2.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur19")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera3.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur20")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera4.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur21")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera5.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur22")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera6.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur23")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera7.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur24")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera8.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur25")}}},
				simulator=self,
				shname="imageBlur",
...
def guide():
	...
	dists.append[RandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.5),scale=torch.tensor(0.1)),"ContRandomVarriablecarDelay9")]
	...
	dists.append[RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur18")]
	dists.append[RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur19")]
	dists.append[RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur20")]
	dists.append[RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur21")]
	dists.append[RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur22")]
	dists.append[RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur23")]
	dists.append[RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur24")]
	dists.append[RandomVariable(pyro.distributions.Bernoulli(self.failureProb[0]),"DiscRandomVarriableimageBlur25")]
