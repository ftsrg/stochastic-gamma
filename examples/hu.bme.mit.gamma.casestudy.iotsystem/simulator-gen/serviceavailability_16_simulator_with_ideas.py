		...
		for port in ports:
			...
			for pevent in pevents:
				if pevent in self.rules[port] and pevent in self.calls[port]:
					...
					time=self.simulator.time+rule.calc(port+"."+pevent,0.0)
					ename=port+"."+pevent
					if time>=0:
...
if67 = JClass('hu.bme.mit.gamma.casestudy.iotsystem.interfaces.EventStreamInterface$Listener$Provided')
...
if68 = JClass('hu.bme.mit.gamma.casestudy.iotsystem.interfaces.DataStreamInterface$Listener$Provided')
if68_s = JClass('hu.bme.mit.gamma.casestudy.iotsystem.scheduling.ElementaryComponentSchedulingInterface')

@JImplements([if68,if68_s])
...
if69 = JClass('hu.bme.mit.gamma.casestudy.iotsystem.interfaces.DataStreamInterface$Listener$Provided')
if69_s = JClass('hu.bme.mit.gamma.casestudy.iotsystem.scheduling.ElementaryComponentSchedulingInterface')

@JImplements([if69,if69_s])
class SampleImageBlur():
	...
	def raiseNewData(self,blurred, car):
		...
		#hu.bme.mit.gamma.expression.model.impl.DecimalTypeDefinitionImpl@2f2c8c2e
		self.event_cntr=self.event_cntr+1
...
class StochasticEventGenerator():
	...
	def __init__(self,detmodel):
		...
		self.components["System.Camera1_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer815")}},
		...
		self.components["System.Camera2_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer816")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera3_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer817")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera4_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer818")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera5_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer819")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera6_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer820")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera7_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer821")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera8_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer822")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera9_.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer823")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera10.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer824")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera11.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer825")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera12.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer826")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera13.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer827")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera14.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer828")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera15.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer829")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Camera16.softwareTimer"].configure(
				...
				rules = {'Events' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.2),scale=torch.tensor(0.02)),"ContRandomVarriablesoftwareTimer830")}},
				portevents = 	{	"Events" : [ "NewEvent"	]},
				simulator=self)
		...
		self.components["System.Traffic.carArrival"].configure(
				...
				rules = {'Cars' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Exponential(torch.tensor(3.0)),"ContRandomVarriablecarArrival831")}},
		...
		self.components["System.Traffic.carDelay"].configure(
				...
				rules = {'CarOut' : {'NewEvent' : ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(0.5),scale=torch.tensor(0.1)),"ContRandomVarriablecarDelay832")}},
				simulator=self)
		...
		self.components["System.Camera1_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur849")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera2_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur850")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera3_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur851")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera4_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur852")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera5_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur853")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera6_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur854")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera7_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur855")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera8_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur856")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera9_.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur857")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera10.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur858")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera11.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur859")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera12.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur860")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera13.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur861")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera14.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur862")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera15.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur863")}}},
				simulator=self,
				shname="imageBlur",
		...
		self.components["System.Camera16.Software.CameraSoftware.imageBlur"].configure(
				...
				rules = {'ImageOut' : {'NewData' : {'blurred' : ContinuousRandomVariable(pyro.distributions.Bernoulli(torch.tensor(0.5)),"DiscRandomVarriableimageBlur864")}}},
				simulator=self,
				shname="imageBlur",
	...
	def popEvent(self):
		...
		if isinstance(event.eventSource,PeriodicEventSource):
			event.eventSource.generateEvents()
		return event
...
if __name__ == "__main__":
	try:
		...
		if DEBUG:
			...
			inference=pyro.infer.Importance(model=simulate, num_samples=100)
