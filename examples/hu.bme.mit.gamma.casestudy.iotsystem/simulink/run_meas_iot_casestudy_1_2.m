...
for i=1:K 
    ...
    networkloss_array_1=[binornd(1,0.10*ones(1,N))];
    networkloss_array_2=[binornd(1,0.10*ones(1,N))];

    blurryness_array_1=[binornd(1,0.50*ones(1,N))];
    blurryness_array_2=[binornd(1,0.50*ones(1,N))];
