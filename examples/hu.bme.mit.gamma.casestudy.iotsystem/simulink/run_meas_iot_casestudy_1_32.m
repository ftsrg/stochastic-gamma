...
for i=1:K 
    ...
    networkloss_array_17=[binornd(1,0.1*ones(1,N))];
    networkloss_array_18=[binornd(1,0.1*ones(1,N))];
    networkloss_array_19=[binornd(1,0.1*ones(1,N))];
    networkloss_array_20=[binornd(1,0.1*ones(1,N))];
    networkloss_array_21=[binornd(1,0.1*ones(1,N))];
    networkloss_array_22=[binornd(1,0.1*ones(1,N))];
    networkloss_array_23=[binornd(1,0.1*ones(1,N))];
    networkloss_array_24=[binornd(1,0.1*ones(1,N))];
    networkloss_array_25=[binornd(1,0.1*ones(1,N))];
    networkloss_array_26=[binornd(1,0.1*ones(1,N))];
    networkloss_array_27=[binornd(1,0.1*ones(1,N))];
    networkloss_array_28=[binornd(1,0.1*ones(1,N))];
    networkloss_array_29=[binornd(1,0.1*ones(1,N))];
    networkloss_array_30=[binornd(1,0.1*ones(1,N))];
    networkloss_array_31=[binornd(1,0.1*ones(1,N))];
    networkloss_array_32=[binornd(1,0.1*ones(1,N))];
    ...
    blurryness_array_17=[binornd(1,0.5*ones(1,N))];
    blurryness_array_18=[binornd(1,0.5*ones(1,N))];
    blurryness_array_19=[binornd(1,0.5*ones(1,N))];
    blurryness_array_20=[binornd(1,0.5*ones(1,N))];
    blurryness_array_21=[binornd(1,0.5*ones(1,N))];
    blurryness_array_22=[binornd(1,0.5*ones(1,N))];
    blurryness_array_23=[binornd(1,0.5*ones(1,N))];
    blurryness_array_24=[binornd(1,0.5*ones(1,N))];
    blurryness_array_25=[binornd(1,0.5*ones(1,N))];
    blurryness_array_26=[binornd(1,0.5*ones(1,N))];
    blurryness_array_27=[binornd(1,0.5*ones(1,N))];
    blurryness_array_28=[binornd(1,0.5*ones(1,N))];
    blurryness_array_29=[binornd(1,0.5*ones(1,N))];
    blurryness_array_30=[binornd(1,0.5*ones(1,N))];
    blurryness_array_31=[binornd(1,0.5*ones(1,N))];
    blurryness_array_32=[binornd(1,0.5*ones(1,N))];
    ...
    timer_array_17=[normrnd(200,20,1,N)];
    timer_array_18=[normrnd(200,20,1,N)];
    timer_array_19=[normrnd(200,20,1,N)];
    timer_array_20=[normrnd(200,20,1,N)];
    timer_array_21=[normrnd(200,20,1,N)];
    timer_array_22=[normrnd(200,20,1,N)];
    timer_array_23=[normrnd(200,20,1,N)];
    timer_array_24=[normrnd(200,20,1,N)];
    timer_array_25=[normrnd(200,20,1,N)];
    timer_array_26=[normrnd(200,20,1,N)];
    timer_array_27=[normrnd(200,20,1,N)];
    timer_array_28=[normrnd(200,20,1,N)];
    timer_array_29=[normrnd(200,20,1,N)];
    timer_array_30=[normrnd(200,20,1,N)];
    timer_array_31=[normrnd(200,20,1,N)];
    timer_array_32=[normrnd(200,20,1,N)];
