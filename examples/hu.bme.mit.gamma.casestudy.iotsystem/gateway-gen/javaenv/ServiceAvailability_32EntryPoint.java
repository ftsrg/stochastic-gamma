...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_32.IoTSystem_32;
...
public class ServiceAvailability_32EntryPoint  {
	
	public IoTSystem_32 detModel=new IoTSystem_32();
	...
	public ServiceAvailability_32EntryPoint(){
	...
	public IoTSystem_32 getDetModel(){
		return detModel;
	}
	
	public IoTSystem_32 getSystem(){
		return detModel;
	}   
