...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_4.IoTSystem_4;
...
public class ServiceAvailability_4EntryPoint  {
	
	public IoTSystem_4 detModel=new IoTSystem_4();
	...
	public ServiceAvailability_4EntryPoint(){
	...
	public IoTSystem_4 getDetModel(){
		return detModel;
	}
	
	public IoTSystem_4 getSystem(){
		return detModel;
	}   
