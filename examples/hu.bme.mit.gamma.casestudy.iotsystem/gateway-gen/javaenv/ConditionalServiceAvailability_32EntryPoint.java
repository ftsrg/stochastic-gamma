...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_param_32.IoTSystemParametric_32;
...
public class ConditionalServiceAvailability_32EntryPoint  {
	
	public IoTSystemParametric_32 detModel=new IoTSystemParametric_32(0.0
	);
	...
	public ConditionalServiceAvailability_32EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new IoTSystemParametric_32(failureProb
		);
		detModel.getFailures().registerListener(monitorOfAspectSystem_Failures_NewEvent);
		detModel.getFailures().registerListener(monitorOfConditionSystem_Failures_NewEvent);
		detModel.getCarLeave().registerListener(monitorOfEndConditionSystem_CarLeave_NewEvent);
	...
	public IoTSystemParametric_32 getDetModel(){
		return detModel;
	}
	
	public IoTSystemParametric_32 getSystem(){
		return detModel;
	}   
