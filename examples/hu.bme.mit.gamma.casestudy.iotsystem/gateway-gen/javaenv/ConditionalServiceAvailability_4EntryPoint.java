...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_param_4.IoTSystemParametric_4;
...
public class ConditionalServiceAvailability_4EntryPoint  {
	
	public IoTSystemParametric_4 detModel=new IoTSystemParametric_4(0.0
	);
	...
	public ConditionalServiceAvailability_4EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new IoTSystemParametric_4(failureProb
		);
		detModel.getFailures().registerListener(monitorOfAspectSystem_Failures_NewEvent);
		detModel.getFailures().registerListener(monitorOfConditionSystem_Failures_NewEvent);
		detModel.getCarLeave().registerListener(monitorOfEndConditionSystem_CarLeave_NewEvent);
	...
	public IoTSystemParametric_4 getDetModel(){
		return detModel;
	}
	
	public IoTSystemParametric_4 getSystem(){
		return detModel;
	}   
