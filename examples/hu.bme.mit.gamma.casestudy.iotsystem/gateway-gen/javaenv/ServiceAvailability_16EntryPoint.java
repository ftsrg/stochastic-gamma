...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_16.IoTSystem_16;
...
public class ServiceAvailability_16EntryPoint  {
	
	public IoTSystem_16 detModel=new IoTSystem_16();
	...
	public ServiceAvailability_16EntryPoint(){
	...
	public IoTSystem_16 getDetModel(){
		return detModel;
	}
	
	public IoTSystem_16 getSystem(){
		return detModel;
	}   
