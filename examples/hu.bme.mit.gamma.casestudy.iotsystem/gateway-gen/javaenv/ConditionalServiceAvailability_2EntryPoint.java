...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_param_2.IoTSystemParametric_2;
...
public class ConditionalServiceAvailability_2EntryPoint  {
	
	public IoTSystemParametric_2 detModel=new IoTSystemParametric_2(0.0
	);
	...
	public ConditionalServiceAvailability_2EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new IoTSystemParametric_2(failureProb
		);
		detModel.getFailures().registerListener(monitorOfAspectSystem_Failures_NewEvent);
		detModel.getFailures().registerListener(monitorOfConditionSystem_Failures_NewEvent);
		detModel.getCarLeave().registerListener(monitorOfEndConditionSystem_CarLeave_NewEvent);
	...
	public IoTSystemParametric_2 getDetModel(){
		return detModel;
	}
	
	public IoTSystemParametric_2 getSystem(){
		return detModel;
	}   
