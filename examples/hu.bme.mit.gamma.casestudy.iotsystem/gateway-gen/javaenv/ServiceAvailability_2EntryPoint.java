...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_2.IoTSystem_2;
...
public class ServiceAvailability_2EntryPoint  {
	
	public IoTSystem_2 detModel=new IoTSystem_2();
	...
	public ServiceAvailability_2EntryPoint(){
	...
	public IoTSystem_2 getDetModel(){
		return detModel;
	}
	
	public IoTSystem_2 getSystem(){
		return detModel;
	}   
