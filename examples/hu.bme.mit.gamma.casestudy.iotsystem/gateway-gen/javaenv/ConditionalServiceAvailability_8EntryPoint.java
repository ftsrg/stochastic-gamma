...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_param_8.IoTSystemParametric_8;
...
public class ConditionalServiceAvailability_8EntryPoint  {
	
	public IoTSystemParametric_8 detModel=new IoTSystemParametric_8(0.0
	);
	...
	public ConditionalServiceAvailability_8EntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new IoTSystemParametric_8(failureProb
		);
		detModel.getFailures().registerListener(monitorOfAspectSystem_Failures_NewEvent);
		detModel.getFailures().registerListener(monitorOfConditionSystem_Failures_NewEvent);
		detModel.getCarLeave().registerListener(monitorOfEndConditionSystem_CarLeave_NewEvent);
	...
	public IoTSystemParametric_8 getDetModel(){
		return detModel;
	}
	
	public IoTSystemParametric_8 getSystem(){
		return detModel;
	}   
