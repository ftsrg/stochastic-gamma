...
import hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_param.IoTSystemParametric2;
...
public class ConditionalServiceAvailabilityEntryPoint  {
	
	public IoTSystemParametric2 detModel=new IoTSystemParametric2(0.0
	);
	...
	public ConditionalServiceAvailabilityEntryPoint(){
	...
	public void reset() {
		...
		detModel=null;
		System.gc();
		detModel=new IoTSystemParametric2(failureProb
		);
		detModel.getFailures().registerListener(monitorOfAspectSystem_Failures_NewEvent);
		detModel.getCarLeave().registerListener(monitorOfEndConditionSystem_CarLeave_NewEvent);
		*/
	...
	public IoTSystemParametric2 getDetModel(){
		return detModel;
	}
	
	public IoTSystemParametric2 getSystem(){
		return detModel;
	}   
