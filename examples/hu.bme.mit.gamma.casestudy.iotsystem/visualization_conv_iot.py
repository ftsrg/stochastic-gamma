...
df = pd.read_csv('measurements/iot_cond_conv_meas.csv')
...
fig = make_subplots(
    rows=1, cols=2,
    subplot_titles=("IoT simulation analysis", "IoT importance analysis"), 
...
df_sim = pd.read_csv('measurements/iot_sim_conv_meas.csv')
...
if not os.path.exists("images"):
    os.mkdir("images")
fig.write_image("images/iot_conv_meas.svg")
fig.write_image("images/iot_conv_meas.pdf")
