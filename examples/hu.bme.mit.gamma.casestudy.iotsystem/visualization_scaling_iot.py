...
df2 = pd.read_csv('measurements/iot_runtime_meas_sim_10e_r5.csv')
df2=df2.groupby("script",as_index=False).median()
df2["method"]="IS"
df2["components"]=df2["script"].map(lambda str1 :int(re.search("\d+", str1).group()))

df1 = pd.read_csv('measurements/iot_runtime_meas_is_10e_r5.csv')
...
if not os.path.exists("images"):
    os.mkdir("images")
fig.write_image("images/iot_scaling_meas.svg")
fig.write_image("images/iot_scaling_meas.pdf")
