...
title1="IoT Simulation"
title2="IoT Importance Sampling"
y_label="Result of the analysis"
x_label="Number of simulations"
data=[]
with open('./iotsystem_sim_conv_meas.csv', encoding='UTF8') as csv_file:
...
data2=[]
with open('./iotsystem_is_conv_meas.csv', encoding='UTF8') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=',')
    for row in csv_reader:
        print(row)
        if len(row)>0:
