		...
		public class IoTSystem_32 implements IoTSystem_32Interface {
			// Component instances
			...
			public boolean isEventQueueEmpty(){
				return  camera1_.isEventQueueEmpty()  &&  camera2_.isEventQueueEmpty()  &&  camera3_.isEventQueueEmpty()  &&  camera4_.isEventQueueEmpty()  &&  camera5_.isEventQueueEmpty()  &&  camera6_.isEventQueueEmpty()  &&  camera7_.isEventQueueEmpty()  &&  camera8_.isEventQueueEmpty()  &&  camera9_.isEventQueueEmpty()  &&  camera10.isEventQueueEmpty()  &&  camera11.isEventQueueEmpty()  &&  camera12.isEventQueueEmpty()  &&  camera13.isEventQueueEmpty()  &&  camera14.isEventQueueEmpty()  &&  camera15.isEventQueueEmpty()  &&  camera16.isEventQueueEmpty()  &&  camera17.isEventQueueEmpty()  &&  camera18.isEventQueueEmpty()  &&  camera19.isEventQueueEmpty()  &&  camera20.isEventQueueEmpty()  &&  camera21.isEventQueueEmpty()  &&  camera22.isEventQueueEmpty()  &&  camera23.isEventQueueEmpty()  &&  camera24.isEventQueueEmpty()  &&  camera25.isEventQueueEmpty()  &&  camera26.isEventQueueEmpty()  &&  camera27.isEventQueueEmpty()  &&  camera28.isEventQueueEmpty()  &&  camera29.isEventQueueEmpty()  &&  camera30.isEventQueueEmpty()  &&  camera31.isEventQueueEmpty()  &&  camera32.isEventQueueEmpty()  &&  edge.isEventQueueEmpty()  &&  traffic.isEventQueueEmpty()     ;
			}
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in IoTSystem_32! -----------");
