		...
		public class IoTSystemParametric_8 implements IoTSystemParametric_8Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in IoTSystemParametric_8! -----------");
			...
			public IoTSystemParametric_8(double failureProb) {
