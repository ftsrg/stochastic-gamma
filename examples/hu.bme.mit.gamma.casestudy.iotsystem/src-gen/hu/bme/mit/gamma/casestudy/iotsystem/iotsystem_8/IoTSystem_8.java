		...
		public class IoTSystem_8 implements IoTSystem_8Interface {
			// Component instances
			private CameraComponent camera1;
			private CameraComponent camera2;
			private CameraComponent camera3;
			private CameraComponent camera4;
			private CameraComponent camera5;
			private CameraComponent camera6;
			private CameraComponent camera7;
			private CameraComponent camera8;
			...
			public boolean isEventQueueEmpty(){
				return  camera1.isEventQueueEmpty()  &&  camera2.isEventQueueEmpty()  &&  camera3.isEventQueueEmpty()  &&  camera4.isEventQueueEmpty()  &&  camera5.isEventQueueEmpty()  &&  camera6.isEventQueueEmpty()  &&  camera7.isEventQueueEmpty()  &&  camera8.isEventQueueEmpty()  &&  edge.isEventQueueEmpty()  &&  traffic.isEventQueueEmpty()     ;
			}
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in IoTSystem_8! -----------");
			...
			public IoTSystem_8() {
				...
				camera3 = new CameraComponent();
				camera4 = new CameraComponent();
				camera5 = new CameraComponent();
				camera6 = new CameraComponent();
				camera7 = new CameraComponent();
				camera8 = new CameraComponent();
...
//
			...
			public boolean isWaiting() {
				return camera1.isWaiting() && camera2.isWaiting() && camera3.isWaiting() && camera4.isWaiting() && camera5.isWaiting() && camera6.isWaiting() && camera7.isWaiting() && camera8.isWaiting() && edge.isWaiting() && traffic.isWaiting()
					;
			}
			...
			public CameraComponent getCamera3() {
				return camera3;
			}
			
			public CameraComponent getCamera4() {
				return camera4;
			}
			
			public CameraComponent getCamera5() {
				return camera5;
			}
			
			public CameraComponent getCamera6() {
				return camera6;
			}
			
			public CameraComponent getCamera7() {
				return camera7;
			}
			
			public CameraComponent getCamera8() {
				return camera8;
			}
