		...
		public class CameraComponentParam implements CameraComponentParamInterface {
			// Component instances
			private CameraAdapterParam software;
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in CameraComponentParam! -----------");
			...
			public CameraComponentParam(double failureProb) {
				this.failureProb = failureProb;
				software = new CameraAdapterParam(failureProb);
...
//
			...
			public CameraAdapterParam getSoftware() {
				return software;
			}
