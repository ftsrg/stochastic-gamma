		package hu.bme.mit.gamma.casestudy.iotsystem.iotsystem_param_2;
		...
		public class IoTSystemParametric_2 implements IoTSystemParametric_2Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in IoTSystemParametric_2! -----------");
			...
			public IoTSystemParametric_2(double failureProb) {
