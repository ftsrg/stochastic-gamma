...
public class CameraAdapterParam implements Runnable, CameraAdapterParamInterface {			
	// Thread running this wrapper instance
	private Thread thread;
	// Wrapped synchronous instance
	private CameraSoftwareParam cameraSoftware;
	...
	public CameraAdapterParam(double failureProb) {
		this.failureProb = failureProb;
		cameraSoftware = new CameraSoftwareParam(failureProb);
	...
	public CameraSoftwareParam getCameraSoftware() {
