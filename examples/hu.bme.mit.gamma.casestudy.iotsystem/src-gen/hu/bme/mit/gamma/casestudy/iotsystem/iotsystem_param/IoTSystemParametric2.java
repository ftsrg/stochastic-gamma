		...
		public class IoTSystemParametric2 implements IoTSystemParametric2Interface {
			// Component instances
			...
			public void schedule(){
				...
				if (cntr==MAX_SCHEDULE) {
					System.out.println("Infinite scheduling in IoTSystemParametric2! -----------");
			...
			public IoTSystemParametric2(double failureProb) {
