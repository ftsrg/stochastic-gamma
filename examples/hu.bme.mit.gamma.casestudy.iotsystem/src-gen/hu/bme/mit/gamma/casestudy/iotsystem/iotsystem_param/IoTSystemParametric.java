...
import hu.bme.mit.gamma.casestudy.iotsystem.traffic_param.*;
...
public class IoTSystemParametric implements IoTSystemParametricInterface {
	// Component instances
	private CameraComponent camera1;
	private CameraComponent camera2;
	private EdgeAdapter edge;
	private RoadTrafficParametric traffic;
	...
	public boolean isEventQueueEmpty(){
		return  camera1.isEventQueueEmpty()  &&  camera2.isEventQueueEmpty()  &&  edge.isEventQueueEmpty()  &&  traffic.isEventQueueEmpty()     ;
	}
	...
	public IoTSystemParametric(double delayMean) {
		this.delayMean = delayMean;
		camera1 = new CameraComponent();
		camera2 = new CameraComponent();
		edge = new EdgeAdapter();
		traffic = new RoadTrafficParametric(delayMean);
	...
	public RoadTrafficParametric getTraffic() {
		return traffic;
	}
