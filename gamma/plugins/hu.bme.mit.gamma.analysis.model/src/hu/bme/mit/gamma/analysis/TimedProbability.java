 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.gamma.analysis.TimedProbability#getTimeLimit <em>Time Limit</em>}</li>
 * </ul>
 *
 * @see hu.bme.mit.gamma.analysis.AnalysisPackage#getTimedProbability()
 * @model
 * @generated
 */
public interface TimedProbability extends AnalysisAspect {
	 ...
	 * @see hu.bme.mit.gamma.analysis.AnalysisPackage#getTimedProbability_TimeLimit()
	 * @model required="true"
	 * @generated
	 */
	double getTimeLimit();
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.gamma.analysis.TimedProbability#getTimeLimit <em>Time Limit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
