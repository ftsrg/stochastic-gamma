    ...
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLine();
      {
        ...
        if (_not_3) {
          ...
          _builder.newLine();
          {
            Collection<QueuesOfClocks.Match> _allMatches_1 = QueuesOfClocks.Matcher.on(this.trace.engine).getAllMatches(component, null, null);
        ...
        for(final ControlSpecification controlSpecification : _controlSpecifications) {
          {
            ...
            if ((_trigger instanceof AnyTrigger)) {
              ...
              {
                Collection<AnyPortTriggersOfWrappers.Match> _allMatches_2 = AnyPortTriggersOfWrappers.Matcher.on(this.trace.engine).getAllMatches(component, controlSpecification, null, null);
              ...
              {
                Collection<PortEventTriggersOfWrappers.Match> _allMatches_3 = PortEventTriggersOfWrappers.Matcher.on(this.trace.engine).getAllMatches(component, controlSpecification, null, null, null);
              ...
              {
                Collection<ClockTriggersOfWrappers.Match> _allMatches_4 = ClockTriggersOfWrappers.Matcher.on(this.trace.engine).getAllMatches(component, controlSpecification, null, null);
