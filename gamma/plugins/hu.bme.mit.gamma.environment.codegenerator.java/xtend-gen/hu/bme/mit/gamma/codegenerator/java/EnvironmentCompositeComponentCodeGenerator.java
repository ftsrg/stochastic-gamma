...
public class EnvironmentCompositeComponentCodeGenerator extends SynchronousCompositeComponentCodeGenerator {
  public EnvironmentCompositeComponentCodeGenerator(final String packageName, final String yakinduPackageName, final Trace trace) {
  ...
  protected CharSequence generateEnvironmentInports(final AbstractSynchronousCompositeComponent component) {
    ...
    EnvironmentCompositeComponent comp = ((EnvironmentCompositeComponent) component);
    _builder.newLineIfNotEmpty();
    final Function1<EnvironmentComponentInstance, Boolean> _function = (EnvironmentComponentInstance c) -> {
      return Boolean.valueOf((c instanceof EnvironmentCompositeComponentInstance));
    };
    final Function1<EnvironmentComponentInstance, EnvironmentCompositeComponentInstance> _function_1 = (EnvironmentComponentInstance c) -> {
      return ((EnvironmentCompositeComponentInstance) c);
    };
    final Function1<EnvironmentCompositeComponentInstance, EnvironmentCompositeComponent> _function_2 = (EnvironmentCompositeComponentInstance c) -> {
      return c.getType();
    };
    Iterable<EnvironmentCompositeComponent> types = IterableExtensions.<EnvironmentCompositeComponentInstance, EnvironmentCompositeComponent>map(IterableExtensions.<EnvironmentComponentInstance, EnvironmentCompositeComponentInstance>map(IterableExtensions.<EnvironmentComponentInstance>filter(comp.getEnvironmentComponents(), _function), _function_1), _function_2);
    _builder.newLineIfNotEmpty();
    {
      for(final EnvironmentCompositeComponent t : types) {
  ...
  protected CharSequence createEnvironmentCompositeComponentClass(final AbstractSynchronousCompositeComponent component) {
    ...
    }
    {
      if ((component instanceof EnvironmentCompositeComponent)) {
        ...
        _builder.newLine();
        {
          EList<EnvironmentComponentInstance> _environmentComponents = ((EnvironmentCompositeComponent)component).getEnvironmentComponents();
          for(final EnvironmentComponentInstance instance_1 : _environmentComponents) {
            {
              if ((instance_1 instanceof EnvironmentCompositeComponentInstance)) {
                _builder.append("\t");
                _builder.append("private ");
                String _generateComponentClassName_2 = this.nameGenerator.generateComponentClassName(((EnvironmentCompositeComponentInstance)instance_1).getType());
                _builder.append(_generateComponentClassName_2, "\t");
                _builder.append(" ");
                String _name_1 = ((EnvironmentCompositeComponentInstance)instance_1).getName();
      ...
      if (_needTimer) {
        ...
        _builder.newLineIfNotEmpty();
        {
          if ((component instanceof EnvironmentCompositeComponent)) {
            ...
            _builder.newLine();
            {
              EList<EnvironmentComponentInstance> _environmentComponents_1 = ((EnvironmentCompositeComponent)component).getEnvironmentComponents();
              for(final EnvironmentComponentInstance instance_2 : _environmentComponents_1) {
                {
                  if ((instance_2 instanceof EnvironmentCompositeComponentInstance)) {
                    _builder.append("\t");
                    _builder.append("\t");
                    _builder.append("\t");
                    String _name_3 = ((EnvironmentCompositeComponentInstance)instance_2).getName();
                    _builder.append(_name_3, "\t\t\t");
                    _builder.append(" = new ");
                    String _firstUpper_1 = StringExtensions.toFirstUpper(((EnvironmentCompositeComponentInstance)instance_2).getType().getName());
    ...
    _builder.newLineIfNotEmpty();
    {
      if ((component instanceof EnvironmentCompositeComponent)) {
        ...
        _builder.newLine();
        {
          EList<EnvironmentComponentInstance> _environmentComponents_2 = ((EnvironmentCompositeComponent)component).getEnvironmentComponents();
          for(final EnvironmentComponentInstance instance_3 : _environmentComponents_2) {
            {
              if ((instance_3 instanceof EnvironmentCompositeComponentInstance)) {
                _builder.append("\t\t");
                _builder.append("\t");
                String _name_5 = ((EnvironmentCompositeComponentInstance)instance_3).getName();
                _builder.append(_name_5, "\t\t\t");
                _builder.append(" = new ");
                String _firstUpper_2 = StringExtensions.toFirstUpper(((EnvironmentCompositeComponentInstance)instance_3).getType().getName());
    ...
    }
    {
      if ((component instanceof EnvironmentCompositeComponent)) {
        {
          EList<EnvironmentComponentInstance> _environmentComponents_3 = ((EnvironmentCompositeComponent)component).getEnvironmentComponents();
          for(final EnvironmentComponentInstance envComp : _environmentComponents_3) {
            {
              if ((envComp instanceof EnvironmentCompositeComponentInstance)) {
                _builder.append("\t\t");
                String _name_8 = ((EnvironmentCompositeComponentInstance)envComp).getName();
    ...
    _builder.newLine();
    {
      Collection<BroadcastChannels.Match> _allMatches_1 = BroadcastChannels.Matcher.on(this.trace.engine).getAllMatches(component, null, null, null);
          ...
          for(final PortBinding portBinding : _portBindings) {
            {
              ...
              boolean _not = (!(_instance instanceof EnvironmentComponentInstance));
              if (_not) {
                _builder.append("\t");
                _builder.append("\t\t");
    ...
    _builder.newLine();
    {
      if ((component instanceof EnvironmentCompositeComponent)) {
        {
          EList<EnvironmentComponentInstance> _environmentComponents_4 = ((EnvironmentCompositeComponent)component).getEnvironmentComponents();
          for(final EnvironmentComponentInstance envComp_1 : _environmentComponents_4) {
            {
              if ((envComp_1 instanceof EnvironmentCompositeComponentInstance)) {
                _builder.append("\t\t");
                String _name_17 = ((EnvironmentCompositeComponentInstance)envComp_1).getName();
    ...
    _builder.newLine();
    {
      List<SynchronousComponentInstance> _scheduledInstances = StatechartModelDerivedFeatures.getScheduledInstances(component);
    ...
    }
    {
      if ((component instanceof EnvironmentCompositeComponent)) {
        {
          EList<EnvironmentComponentInstance> _environmentComponents_5 = ((EnvironmentCompositeComponent)component).getEnvironmentComponents();
          for(final EnvironmentComponentInstance instance_9 : _environmentComponents_5) {
            {
              if ((instance_9 instanceof EnvironmentCompositeComponentInstance)) {
                _builder.append("\t\t");
                String _name_22 = ((EnvironmentCompositeComponentInstance)instance_9).getName();
    ...
    _builder.newLine();
    {
      if ((component instanceof EnvironmentCompositeComponent)) {
        ...
        _builder.newLine();
        {
          EList<EnvironmentComponentInstance> _environmentComponents_6 = ((EnvironmentCompositeComponent)component).getEnvironmentComponents();
          for(final EnvironmentComponentInstance instance_12 : _environmentComponents_6) {
            {
              if ((instance_12 instanceof EnvironmentCompositeComponentInstance)) {
                _builder.append("\t");
                _builder.append("\t");
                _builder.append("public ");
                String _generateComponentClassName_6 = this.nameGenerator.generateComponentClassName(((EnvironmentCompositeComponentInstance)instance_12).getType());
                _builder.append(_generateComponentClassName_6, "\t\t");
                _builder.append(" get");
                String _firstUpper_44 = StringExtensions.toFirstUpper(((EnvironmentCompositeComponentInstance)instance_12).getName());
                ...
                _builder.append("\t");
                _builder.append("return ");
                String _name_25 = ((EnvironmentCompositeComponentInstance)instance_12).getName();
