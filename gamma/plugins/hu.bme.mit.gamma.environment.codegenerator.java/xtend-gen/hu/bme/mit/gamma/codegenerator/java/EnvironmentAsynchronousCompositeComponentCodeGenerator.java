...
public class EnvironmentAsynchronousCompositeComponentCodeGenerator {
  ...
  protected CharSequence createEnvironmentAsynchronousCompositeComponentClass(final AsynchronousCompositeComponent component, final int channelId1, final int channelId2) {
    StringConcatenation _builder = new StringConcatenation();
