...
public class PyroComponentClassGenerator {
  ...
  public CharSequence generateSampleClasses(final List<EnvironmentConnections> connections) {
    ...
    _builder.newLineIfNotEmpty();
    {
      for(final Interface i : interfaces) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("def __init__(self,name,inport,calls,rules,simulator):");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("self.name=name");
        _builder.newLine();
        ...
        _builder.newLine();
        {
          ...
          for(final EventDeclaration event : _events) {
            ...
            _builder.newLineIfNotEmpty();
            _builder.append("\t\t\t\t");
            _builder.append("self.simulator.events.append(Event(self,self.simulator.time,callEvent))");
            _builder.newLine();
            _builder.append("\t\t\t");
            _builder.append("else:");
            _builder.newLine();
            _builder.append("\t\t\t\t");
            _builder.append("callEvent=call.raise");
  ...
  public String generateSwitchClasses(final List<EnvironmentConnections> connections) {
    ...
    for (final Interface i : interfaces) {
      ...
      _builder.newLineIfNotEmpty();
      _builder.append("\t");
      _builder.append("def __init__(self,name,inport,calls,portarray,categorical,simulator):");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("self.name=name");
      _builder.newLine();
