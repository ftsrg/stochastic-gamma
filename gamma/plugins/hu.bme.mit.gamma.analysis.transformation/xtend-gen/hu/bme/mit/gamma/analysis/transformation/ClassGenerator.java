...
public class ClassGenerator {
    ...
    for (final Interface i : interfaces) {
      ...
      _builder.newLine();
      {
        ...
        for(final EventDeclaration event : _events) {
          ...
          _builder.append("\t");
          _builder.append("\t");
          _builder.append("failureTime=time+actualTime");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("\t");
  ...
  public String generateSwitchClasses(final List<EnvironmentConnections> connections) {
    ...
    for (final Interface i : interfaces) {
      ...
      _builder.newLineIfNotEmpty();
      _builder.append("\t");
      _builder.append("def __init__(self,name,inport,calls,portarray,categorical,detmodel):");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("self.name=name");
      _builder.newLine();
  ...
  public CharSequence generateSwitchInstances(final List<EnvironmentConnections> connections) {
    StringConcatenation _builder = new StringConcatenation();
    {
      for(final EnvironmentConnections connection : connections) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("name=\"Switch");
        String _name = connection.component.getName();
        _builder.append(_name, "\t\t");
        String _string = (ClassGenerator.cntr++).toString();
        _builder.append(_string, "\t\t");
        _builder.append("\",");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
    ...
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLine();
      {
        for(final EnvironmentConnections connection : connections) {
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("name  = \"Delay");
          String _firstUpper_1 = StringExtensions.toFirstUpper(connection.component.getName());
          _builder.append(_firstUpper_1, "\t");
          String _string = (ClassGenerator.cntr++).toString();
          _builder.append(_string, "\t");
          _builder.append("\",");
  ...
  public CharSequence generatePeriodicEventSourceInstances(final List<EnvironmentConnections> connections) {
    StringConcatenation _builder = new StringConcatenation();
    {
      for(final EnvironmentConnections connection : connections) {
        ...
        _builder.newLine();
        _builder.append("\t");
        _builder.append("name  = \"PeriodicEventSource");
        String _firstUpper = StringExtensions.toFirstUpper(connection.component.getName());
        _builder.append(_firstUpper, "\t");
        String _string = (ClassGenerator.cntr++).toString();
        _builder.append(_string, "\t");
  ...
  public CharSequence generateEventSourceInstances(final List<EnvironmentConnections> connections) {
    StringConcatenation _builder = new StringConcatenation();
    {
      for(final EnvironmentConnections connection : connections) {
        ...
        _builder.newLine();
        _builder.append("\t");
        _builder.append("name  = \"EventSource");
        String _firstUpper = StringExtensions.toFirstUpper(connection.component.getName());
        _builder.append(_firstUpper, "\t");
        String _string = (ClassGenerator.cntr++).toString();
        _builder.append(_string, "\t");
  ...
  public CharSequence generateRandomVariableClass() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def __init__(self,dist,name,N=1000):");
    _builder.newLine();
    _builder.append("\t\t");
  ...
  protected CharSequence _generateStochasticModel(final FittedGaussianProcess variable, final String name) {
    ...
    String _generateKernel = ClassGenerator.generateKernel(variable.getKernel());
    ...
    _builder.append(name, "\t");
    String _string_1 = (ClassGenerator.distcntr++).toString();
    _builder.append(_string_1, "\t");
    _builder.append("\"");
    _builder.newLineIfNotEmpty();
    _builder.append(")");
  ...
  protected CharSequence _generateDitribution(final NormalRandomVariable dist) {
    ...
    _builder.append("\t\t");
    _builder.append("torch.tensor(");
    String _string = Double.valueOf(dist.getMean()).toString();
    _builder.append(_string, "\t\t");
    _builder.append("),");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("torch.tensor(");
    String _string_1 = Double.valueOf(dist.getScale()).toString();
    _builder.append(_string_1, "\t\t");
    _builder.append(")");
    _builder.newLineIfNotEmpty();
    _builder.append(")");
  ...
  protected CharSequence _generateDitribution(final WeibullRandomVariable dist) {
    ...
    String _string = Double.valueOf(dist.getShape()).toString();
    _builder.append(_string, "\t\t");
    _builder.append("),");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
  ...
  protected CharSequence _generateDitribution(final ExponentialRandomVariable dist) {
    ...
    String _string = Double.valueOf(dist.getRate()).toString();
    _builder.append(_string);
    _builder.append("))");
    return _builder;
  }
  ...
  protected CharSequence _generateDitribution(final BernoulliRandomVariable dist) {
    ...
    String _string = Double.valueOf(dist.getProbability()).toString();
    _builder.append(_string);
    _builder.append("))");
    return _builder;
  }
  ...
  protected CharSequence _generateStochasticProcess(final FittedGaussianProcess gp) {
    ...
    _builder.append("\t");
    _builder.append("kernel=");
    String _generateKernel = ClassGenerator.generateKernel(gp.getKernel());
    _builder.append(_generateKernel, "\t");
    _builder.newLineIfNotEmpty();
  ...
  protected static String _generateKernel(final SumKernel kernel) {
    ...
    Object _generateKernel = ClassGenerator.generateKernel(kernel.getKernels().get(0));
    _builder.append(_generateKernel);
    _builder.append(",");
    Object _generateKernel_1 = ClassGenerator.generateKernel(kernel.getKernels().get(1));
