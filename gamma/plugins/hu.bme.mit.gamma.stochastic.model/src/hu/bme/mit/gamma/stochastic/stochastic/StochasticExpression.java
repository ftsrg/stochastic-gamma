 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.gamma.stochastic.stochastic.StochasticExpression#getRandomvariable <em>Randomvariable</em>}</li>
 * </ul>
 *
 * @see hu.bme.mit.gamma.stochastic.stochastic.StochasticPackage#getStochasticExpression()
 * @model
 * @generated
 */
public interface StochasticExpression extends Expression {
	 ...
	 * @see hu.bme.mit.gamma.stochastic.stochastic.StochasticPackage#getStochasticExpression_Randomvariable()
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.gamma.stochastic.stochastic.StochasticExpression#getRandomvariable <em>Randomvariable</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
