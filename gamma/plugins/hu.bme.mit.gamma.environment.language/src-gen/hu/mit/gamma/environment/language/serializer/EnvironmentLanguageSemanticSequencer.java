...
import hu.bme.mit.gamma.statechart.statechart.StatechartReference;
...
public class EnvironmentLanguageSemanticSequencer extends StatechartLanguageSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == AnalysisPackage.eINSTANCE)
			...
			case CompositeModelPackage.CASCADE_COMPOSITE_COMPONENT:
				...
				return; 
			case CompositeModelPackage.COMPONENT_INSTANCE_REFERENCE:
				sequence_ComponentInstanceReference(context, (ComponentInstanceReference) semanticObject); 
				return; 
		...
		else if (epackage == EnvironentPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			...
			case EnvironentPackage.ENVIRONMENT_COMPOSITE_COMPONENT:
				sequence_EnvironmentCompositeComponent(context, (EnvironmentCompositeComponent) semanticObject); 
				return; 
			case EnvironentPackage.ENVIRONMENT_COMPOSITE_COMPONENT_INSTANCE:
				sequence_EnvironmentCompositeComponentInstance(context, (EnvironmentCompositeComponentInstance) semanticObject); 
				return; 
			...
			case PhaseModelPackage.MISSION_PHASE_STATE_ANNOTATION:
				...
				return; 
			case PhaseModelPackage.MISSION_PHASE_STATE_DEFINITION:
				sequence_StateDefinition(context, (MissionPhaseStateDefinition) semanticObject); 
				return; 
			...
			case StatechartModelPackage.STATE_REFERENCE_EXPRESSION:
				...
				return; 
			case StatechartModelPackage.STATECHART_DEFINITION:
				sequence_StatechartDefinition(context, (StatechartDefinition) semanticObject); 
				return; 
			case StatechartModelPackage.STATECHART_REFERENCE:
				sequence_StatechartReference(context, (StatechartReference) semanticObject); 
				return; 
	...
	protected void sequence_AssumeNotRaised(ISerializationContext context, AssumeNotRaised semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, AnalysisPackage.Literals.ANALYSIS_CONDITION__EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AnalysisPackage.Literals.ANALYSIS_CONDITION__EVENT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAssumeNotRaisedAccess().getEventComponentPortEventReferenceParserRuleCall_1_0(), semanticObject.getEvent());
		feeder.finish();
	}
	...
	protected void sequence_AssumeRaised(ISerializationContext context, AssumeRaised semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAssumeRaisedAccess().getEventComponentPortEventReferenceParserRuleCall_1_0(), semanticObject.getEvent());
		feeder.finish();
	}
	...
	protected void sequence_BernoulliRandomVariable(ISerializationContext context, BernoulliRandomVariable semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getBernoulliRandomVariableAccess().getProbabilityDOUBLETerminalRuleCall_2_0(), semanticObject.getProbability());
		feeder.finish();
	}
	...
	protected void sequence_CategoricalProbabaility(ISerializationContext context, CategoricalProbabaility semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getCategoricalProbabailityAccess().getProbabilityDOUBLETerminalRuleCall_0(), semanticObject.getProbability());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (component=[EnvironmentCompositeComponentInstance|ID] port=[Port|ID] event=[Event|ID])
	 */
	protected void sequence_ComponentPortEventReference(ISerializationContext context, ComponentPortEventReference semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getComponentPortEventReferenceAccess().getComponentEnvironmentCompositeComponentInstanceIDTerminalRuleCall_2_0_1(), semanticObject.eGet(AnalysisPackage.Literals.COMPONENT_PORT_EVENT_REFERENCE__COMPONENT, false));
		feeder.accept(grammarAccess.getComponentPortEventReferenceAccess().getPortPortIDTerminalRuleCall_4_0_1(), semanticObject.eGet(AnalysisPackage.Literals.COMPONENT_PORT_EVENT_REFERENCE__PORT, false));
		feeder.accept(grammarAccess.getComponentPortEventReferenceAccess().getEventEventIDTerminalRuleCall_6_0_1(), semanticObject.eGet(AnalysisPackage.Literals.COMPONENT_PORT_EVENT_REFERENCE__EVENT, false));
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     EnvironmentComponentInstance returns EnvironmentCompositeComponentInstance
	 *     EnvironmentCompositeComponentInstance returns EnvironmentCompositeComponentInstance
	 *
	 * Constraint:
	 *     (name=ID type=[EnvironmentCompositeComponent|ID] (arguments+=Expression arguments+=Expression*)?)
	 */
	protected void sequence_EnvironmentCompositeComponentInstance(ISerializationContext context, EnvironmentCompositeComponentInstance semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     Component returns EnvironmentCompositeComponent
	 *     EnvironmentCompositeComponent returns EnvironmentCompositeComponent
	 *
	 * Constraint:
	 *     (
	 *         name=ID 
	 ...
	 *             (executionList+=[SynchronousComponentInstance|ID] executionList+=[SynchronousComponentInstance|ID]*)?
	 *         )+
	 *     )
	 */
	protected void sequence_EnvironmentCompositeComponent(ISerializationContext context, EnvironmentCompositeComponent semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID inports+=Port outports+=Port (behaviorRules+=StochasticRule | behaviorRules+=FilterSimulationRule)+)
	 */
	...
	protected void sequence_EventFilter(ISerializationContext context, EventFilter semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EnvironentPackage.Literals.EVENT_FILTER__EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EnvironentPackage.Literals.EVENT_FILTER__EVENT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ExponentialRandomVariable(ISerializationContext context, ExponentialRandomVariable semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getExponentialRandomVariableAccess().getRateDOUBLETerminalRuleCall_2_0(), semanticObject.getRate());
		feeder.finish();
	}
	...
	protected void sequence_GammaRandomVariable(ISerializationContext context, GammaRandomVariable semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getGammaRandomVariableAccess().getScaleDOUBLETerminalRuleCall_3_0(), semanticObject.getScale());
		feeder.accept(grammarAccess.getGammaRandomVariableAccess().getShapeDOUBLETerminalRuleCall_7_0(), semanticObject.getShape());
		feeder.finish();
	}
	...
	protected void sequence_NormalRandomVariable(ISerializationContext context, NormalRandomVariable semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNormalRandomVariableAccess().getMeanDOUBLETerminalRuleCall_3_0(), semanticObject.getMean());
		feeder.accept(grammarAccess.getNormalRandomVariableAccess().getScaleDOUBLETerminalRuleCall_7_0(), semanticObject.getScale());
		feeder.finish();
	}
	...
	protected void sequence_PortFilter(ISerializationContext context, PortFilter semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EnvironentPackage.Literals.PORT_FILTER__PORT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EnvironentPackage.Literals.PORT_FILTER__PORT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPortFilterAccess().getPortPortIDTerminalRuleCall_0_0_1(), semanticObject.eGet(EnvironentPackage.Literals.PORT_FILTER__PORT, false));
		feeder.finish();
	}
	...
	protected void sequence_SimulationRule(ISerializationContext context, SimulationRule semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EnvironentPackage.Literals.SIMULATION_RULE__SIMULATION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EnvironentPackage.Literals.SIMULATION_RULE__SIMULATION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Simulation(ISerializationContext context, Simulation semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EnvironentPackage.Literals.SIMULATION__SIMULATION_CLASS_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EnvironentPackage.Literals.SIMULATION__SIMULATION_CLASS_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	/**
	 * Contexts:
	 *     AnalysisAspect returns TimeBoundedProbability
	...
	/**
	 * Contexts:
	 *     AnalysisAspect returns TimedProbability
	...
	protected void sequence_WeibullRandomVariable(ISerializationContext context, WeibullRandomVariable semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWeibullRandomVariableAccess().getScaleDOUBLETerminalRuleCall_3_0(), semanticObject.getScale());
		feeder.accept(grammarAccess.getWeibullRandomVariableAccess().getShapeDOUBLETerminalRuleCall_7_0(), semanticObject.getShape());
		feeder.finish();
	}
