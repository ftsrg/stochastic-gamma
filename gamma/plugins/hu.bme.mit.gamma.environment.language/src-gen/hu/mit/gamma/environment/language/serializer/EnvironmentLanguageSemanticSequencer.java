...
public class EnvironmentLanguageSemanticSequencer extends StatechartLanguageSemanticSequencer {
	...
	protected void sequence_ParameterFilter(ISerializationContext context, ParameterFilter semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EnvironentPackage.Literals.EVENT_FILTER__EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EnvironentPackage.Literals.EVENT_FILTER__EVENT));
			if (transientValues.isValueTransient(semanticObject, EnvironentPackage.Literals.PARAMETER_FILTER__PARAMETER) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EnvironentPackage.Literals.PARAMETER_FILTER__PARAMETER));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		...
		feeder.accept(grammarAccess.getParameterFilterAccess().getParameterParameterDeclarationIDTerminalRuleCall_2_0_1(), semanticObject.eGet(EnvironentPackage.Literals.PARAMETER_FILTER__PARAMETER, false));
		feeder.finish();
	}
