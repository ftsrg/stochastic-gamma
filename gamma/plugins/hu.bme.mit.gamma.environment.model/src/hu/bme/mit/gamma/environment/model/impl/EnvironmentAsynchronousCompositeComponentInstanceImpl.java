...
public class EnvironmentAsynchronousCompositeComponentInstanceImpl extends AbstractEnvironmentCompositeComponentInstanceImpl implements EnvironmentAsynchronousCompositeComponentInstance {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.ENVIRONMENT_ASYNCHRONOUS_COMPOSITE_COMPONENT_INSTANCE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EnvironentPackage.ENVIRONMENT_ASYNCHRONOUS_COMPOSITE_COMPONENT_INSTANCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EnvironmentAsynchronousCompositeComponent newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironentPackage.ENVIRONMENT_ASYNCHRONOUS_COMPOSITE_COMPONENT_INSTANCE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironentPackage.ENVIRONMENT_ASYNCHRONOUS_COMPOSITE_COMPONENT_INSTANCE__TYPE:
