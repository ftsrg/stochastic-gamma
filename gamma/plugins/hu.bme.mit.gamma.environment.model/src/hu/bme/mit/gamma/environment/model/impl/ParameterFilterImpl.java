...
public class ParameterFilterImpl extends EventFilterImpl implements ParameterFilter {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.PARAMETER_FILTER;
	}
		...
		if (parameter != null && parameter.eIsProxy()) {
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EnvironentPackage.PARAMETER_FILTER__PARAMETER, oldParameter, parameter));
			}
		}
		return parameter;
	}
	...
	public void setParameter(ParameterDeclaration newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironentPackage.PARAMETER_FILTER__PARAMETER, oldParameter, parameter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironentPackage.PARAMETER_FILTER__PARAMETER:
