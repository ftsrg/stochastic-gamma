...
public class SimulationImpl extends MinimalEObjectImpl.Container implements Simulation {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.SIMULATION;
	}
	...
	public void setSimulationClassName(String newSimulationClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironentPackage.SIMULATION__SIMULATION_CLASS_NAME, oldSimulationClassName, simulationClassName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironentPackage.SIMULATION__SIMULATION_CLASS_NAME:
