...
public abstract class AbstractEnvironmentCompositeComponentImpl extends EnvironmentComponentImpl implements AbstractEnvironmentCompositeComponent {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.ABSTRACT_ENVIRONMENT_COMPOSITE_COMPONENT;
	}
	...
	public EList<EnvironmentComponentInstance> getEnvironmentComponents() {
		if (environmentComponents == null) {
			environmentComponents = new EObjectContainmentEList<EnvironmentComponentInstance>(EnvironmentComponentInstance.class, this, EnvironentPackage.ABSTRACT_ENVIRONMENT_COMPOSITE_COMPONENT__ENVIRONMENT_COMPONENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironentPackage.ABSTRACT_ENVIRONMENT_COMPOSITE_COMPONENT__ENVIRONMENT_COMPONENTS:
