...
public class PeriodicSimulationImpl extends SimulationImpl implements PeriodicSimulation {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.PERIODIC_SIMULATION;
	}
	...
	public void setPeriodTime(double newPeriodTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironentPackage.PERIODIC_SIMULATION__PERIOD_TIME, oldPeriodTime, periodTime));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironentPackage.PERIODIC_SIMULATION__PERIOD_TIME:
