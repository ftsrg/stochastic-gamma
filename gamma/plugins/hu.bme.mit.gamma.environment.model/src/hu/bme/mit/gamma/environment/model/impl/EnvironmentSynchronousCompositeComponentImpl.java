...
public class EnvironmentSynchronousCompositeComponentImpl extends AbstractEnvironmentCompositeComponentImpl implements EnvironmentSynchronousCompositeComponent {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__NAME, oldName, name));
	}
	...
	public EList<ParameterDeclaration> getParameterDeclarations() {
		if (parameterDeclarations == null) {
			parameterDeclarations = new EObjectContainmentEList<ParameterDeclaration>(ParameterDeclaration.class, this, EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PARAMETER_DECLARATIONS);
		}
	...
	public EList<Port> getPorts() {
		if (ports == null) {
			ports = new EObjectContainmentEList<Port>(Port.class, this, EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PORTS);
		}
		return ports;
	}
	...
	public EList<FunctionDeclaration> getFunctionDeclarations() {
		if (functionDeclarations == null) {
			functionDeclarations = new EObjectContainmentEList<FunctionDeclaration>(FunctionDeclaration.class, this, EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__FUNCTION_DECLARATIONS);
		}
	...
	public EList<Channel> getChannels() {
		if (channels == null) {
			channels = new EObjectContainmentEList<Channel>(Channel.class, this, EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__CHANNELS);
		}
		return channels;
	}
	...
	public EList<SynchronousComponentInstance> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<SynchronousComponentInstance>(SynchronousComponentInstance.class, this, EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__COMPONENTS);
		}
		return components;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PARAMETER_DECLARATIONS:
				return ((InternalEList<?>)getParameterDeclarations()).basicRemove(otherEnd, msgs);
			case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PORTS:
			...
			case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__COMPONENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__NAME:
				return getName();
			case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PARAMETER_DECLARATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__NAME: return ExpressionModelPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == ParametricElement.class) {
			switch (derivedFeatureID) {
				case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PARAMETER_DECLARATIONS: return ExpressionModelPackage.PARAMETRIC_ELEMENT__PARAMETER_DECLARATIONS;
				default: return -1;
			}
		}
		...
		if (baseClass == CompositeComponent.class) {
			switch (derivedFeatureID) {
				case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PORT_BINDINGS: return CompositeModelPackage.COMPOSITE_COMPONENT__PORT_BINDINGS;
				case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__CHANNELS: return CompositeModelPackage.COMPOSITE_COMPONENT__CHANNELS;
				default: return -1;
			}
		}
		...
		if (baseClass == AbstractSynchronousCompositeComponent.class) {
			switch (derivedFeatureID) {
				case EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__COMPONENTS: return CompositeModelPackage.ABSTRACT_SYNCHRONOUS_COMPOSITE_COMPONENT__COMPONENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case ExpressionModelPackage.NAMED_ELEMENT__NAME: return EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == ParametricElement.class) {
			switch (baseFeatureID) {
				case ExpressionModelPackage.PARAMETRIC_ELEMENT__PARAMETER_DECLARATIONS: return EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PARAMETER_DECLARATIONS;
				default: return -1;
			}
		}
		if (baseClass == Component.class) {
		...
		if (baseClass == CompositeComponent.class) {
			switch (baseFeatureID) {
				case CompositeModelPackage.COMPOSITE_COMPONENT__PORT_BINDINGS: return EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__PORT_BINDINGS;
				case CompositeModelPackage.COMPOSITE_COMPONENT__CHANNELS: return EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__CHANNELS;
				default: return -1;
			}
		}
		if (baseClass == SynchronousComponent.class) {
		...
		if (baseClass == AbstractSynchronousCompositeComponent.class) {
			switch (baseFeatureID) {
				case CompositeModelPackage.ABSTRACT_SYNCHRONOUS_COMPOSITE_COMPONENT__COMPONENTS: return EnvironentPackage.ENVIRONMENT_SYNCHRONOUS_COMPOSITE_COMPONENT__COMPONENTS;
				default: return -1;
			}
		}
		if (baseClass == SynchronousCompositeComponent.class) {
