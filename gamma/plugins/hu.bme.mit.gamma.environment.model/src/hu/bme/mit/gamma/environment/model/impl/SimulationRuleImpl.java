...
public class SimulationRuleImpl extends EnvironmentRuleImpl implements SimulationRule {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.SIMULATION_RULE;
	}
	...
	public NotificationChain basicSetSimulation(Simulation newSimulation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EnvironentPackage.SIMULATION_RULE__SIMULATION, oldSimulation, newSimulation);
	...
	public void setSimulation(Simulation newSimulation) {
		if (newSimulation != simulation) {
			...
			if (simulation != null)
				msgs = ((InternalEObject)simulation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EnvironentPackage.SIMULATION_RULE__SIMULATION, null, msgs);
			if (newSimulation != null)
				msgs = ((InternalEObject)newSimulation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EnvironentPackage.SIMULATION_RULE__SIMULATION, null, msgs);
			msgs = basicSetSimulation(newSimulation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironentPackage.SIMULATION_RULE__SIMULATION, newSimulation, newSimulation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironentPackage.SIMULATION_RULE__SIMULATION:
