...
public class StochasticRuleImpl extends EnvironmentRuleImpl implements StochasticRule {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.STOCHASTIC_RULE;
	}
	...
	public NotificationChain basicSetStochasticModel(StochasticModel newStochasticModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EnvironentPackage.STOCHASTIC_RULE__STOCHASTIC_MODEL, oldStochasticModel, newStochasticModel);
	...
	public void setStochasticModel(StochasticModel newStochasticModel) {
		if (newStochasticModel != stochasticModel) {
			...
			if (stochasticModel != null)
				msgs = ((InternalEObject)stochasticModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EnvironentPackage.STOCHASTIC_RULE__STOCHASTIC_MODEL, null, msgs);
			if (newStochasticModel != null)
				msgs = ((InternalEObject)newStochasticModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EnvironentPackage.STOCHASTIC_RULE__STOCHASTIC_MODEL, null, msgs);
			msgs = basicSetStochasticModel(newStochasticModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironentPackage.STOCHASTIC_RULE__STOCHASTIC_MODEL, newStochasticModel, newStochasticModel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironentPackage.STOCHASTIC_RULE__STOCHASTIC_MODEL:
