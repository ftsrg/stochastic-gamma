...
public class EnvironmentCascadeCompositeComponentImpl extends CascadeCompositeComponentImpl implements EnvironmentCascadeCompositeComponent {
	...
	protected EClass eStaticClass() {
		return EnvironentPackage.Literals.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT;
	}
	...
	public EList<EnvironmentComponentInstance> getEnvironmentComponents() {
		if (environmentComponents == null) {
			environmentComponents = new EObjectContainmentEList<EnvironmentComponentInstance>(EnvironmentComponentInstance.class, this, EnvironentPackage.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT__ENVIRONMENT_COMPONENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironentPackage.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT__ENVIRONMENT_COMPONENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == AbstractEnvironmentCompositeComponent.class) {
			switch (derivedFeatureID) {
				case EnvironentPackage.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT__ENVIRONMENT_COMPONENTS: return EnvironentPackage.ABSTRACT_ENVIRONMENT_COMPOSITE_COMPONENT__ENVIRONMENT_COMPONENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == AbstractEnvironmentCompositeComponent.class) {
			switch (baseFeatureID) {
				case EnvironentPackage.ABSTRACT_ENVIRONMENT_COMPOSITE_COMPONENT__ENVIRONMENT_COMPONENTS: return EnvironentPackage.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT__ENVIRONMENT_COMPONENTS;
				default: return -1;
			}
		}
