 ...
 ********************************************************************************/
package hu.bme.mit.gamma.environment.language.formatter;
...
public class EnvironmentLanguageFormatter extends StatechartLanguageFormatter{
	private final ActionLanguageFormatterUtil actionLanguageFormatterUtil =
			new ActionLanguageFormatterUtil();
	@Override
	protected void configureFormatting(FormattingConfig c) {
		EnvironmentLanguageGrammarAccess f = (EnvironmentLanguageGrammarAccess) getGrammarAccess();
