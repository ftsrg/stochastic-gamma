...
public class EventFilterImpl extends FilterImpl implements EventFilter {
	...
	protected EClass eStaticClass() {
		return EnvironmentModelPackage.Literals.EVENT_FILTER;
	}
	...
	public NotificationChain basicSetEvent(PortEventReference newEvent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EnvironmentModelPackage.EVENT_FILTER__EVENT, oldEvent, newEvent);
	...
	public void setEvent(PortEventReference newEvent) {
		if (newEvent != event) {
			...
			if (event != null)
				msgs = ((InternalEObject)event).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EnvironmentModelPackage.EVENT_FILTER__EVENT, null, msgs);
			if (newEvent != null)
				msgs = ((InternalEObject)newEvent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EnvironmentModelPackage.EVENT_FILTER__EVENT, null, msgs);
			msgs = basicSetEvent(newEvent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentModelPackage.EVENT_FILTER__EVENT, newEvent, newEvent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironmentModelPackage.EVENT_FILTER__EVENT:
