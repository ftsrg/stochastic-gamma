...
public abstract class ElementaryEnvironmentComponentInstanceImpl extends EnvironmentComponentInstanceImpl implements ElementaryEnvironmentComponentInstance {
	...
	protected EClass eStaticClass() {
		return EnvironmentModelPackage.Literals.ELEMENTARY_ENVIRONMENT_COMPONENT_INSTANCE;
	}
	...
	public EList<Port> getOutports() {
		if (outports == null) {
			outports = new EObjectContainmentEList<Port>(Port.class, this, EnvironmentModelPackage.ELEMENTARY_ENVIRONMENT_COMPONENT_INSTANCE__OUTPORTS);
		}
		return outports;
	}
	...
	public EList<Port> getInports() {
		if (inports == null) {
			inports = new EObjectContainmentEList<Port>(Port.class, this, EnvironmentModelPackage.ELEMENTARY_ENVIRONMENT_COMPONENT_INSTANCE__INPORTS);
		}
		return inports;
	}
	...
	public EList<EnvironmentRule> getBehaviorRules() {
		if (behaviorRules == null) {
			behaviorRules = new EObjectContainmentEList<EnvironmentRule>(EnvironmentRule.class, this, EnvironmentModelPackage.ELEMENTARY_ENVIRONMENT_COMPONENT_INSTANCE__BEHAVIOR_RULES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironmentModelPackage.ELEMENTARY_ENVIRONMENT_COMPONENT_INSTANCE__OUTPORTS:
				return ((InternalEList<?>)getOutports()).basicRemove(otherEnd, msgs);
			case EnvironmentModelPackage.ELEMENTARY_ENVIRONMENT_COMPONENT_INSTANCE__INPORTS:
				return ((InternalEList<?>)getInports()).basicRemove(otherEnd, msgs);
			case EnvironmentModelPackage.ELEMENTARY_ENVIRONMENT_COMPONENT_INSTANCE__BEHAVIOR_RULES:
