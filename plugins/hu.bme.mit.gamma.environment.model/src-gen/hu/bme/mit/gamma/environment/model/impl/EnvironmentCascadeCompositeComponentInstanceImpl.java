...
public class EnvironmentCascadeCompositeComponentInstanceImpl extends AbstractEnvironmentCompositeComponentInstanceImpl implements EnvironmentCascadeCompositeComponentInstance {
	...
	protected EClass eStaticClass() {
		return EnvironmentModelPackage.Literals.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT_INSTANCE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EnvironmentModelPackage.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT_INSTANCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EnvironmentCascadeCompositeComponent newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentModelPackage.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT_INSTANCE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironmentModelPackage.ENVIRONMENT_CASCADE_COMPOSITE_COMPONENT_INSTANCE__TYPE:
