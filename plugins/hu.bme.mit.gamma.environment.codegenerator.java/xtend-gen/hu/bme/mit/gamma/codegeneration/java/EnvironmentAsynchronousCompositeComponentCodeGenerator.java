...
public class EnvironmentAsynchronousCompositeComponentCodeGenerator {
  ...
  protected CharSequence createEnvironmentAsynchronousCompositeComponentClass(final AbstractAsynchronousCompositeComponent component, final int channelId1, final int channelId2) {
    ...
    _builder.newLine();
    {
      Set<SimpleChannel> _allValuesOfsimpleChannel = SimpleChannels.Matcher.on(this.trace.getEngine()).getAllValuesOfsimpleChannel(component, null, null);
    ...
    {
      Set<BroadcastChannel> _allValuesOfbroadcastChannel = BroadcastChannels.Matcher.on(this.trace.getEngine()).getAllValuesOfbroadcastChannel(component, null, null);
    ...
    _builder.append(" ");
    {
      if ((component instanceof EnvironmentAsynchronousCompositeComponent)) {
        ...
        _builder.append(" ");
        {
          ...
          for(final EnvironmentComponentInstance inst : _environmentComponents_1) {
            if (!_hasElements_1) {
              _hasElements_1 = true;
            } else {
              _builder.appendImmediate(" && ", "\t\t");
    ...
    _builder.newLine();
    {
      ...
      for(final ComponentInstance inst_1 : _instances_1) {
        _builder.append("\t\t\t");
        String _name_3 = inst_1.getName();
      ...
      if ((component instanceof EnvironmentAsynchronousCompositeComponent)) {
        {
          ...
          for(final EnvironmentComponentInstance inst_2 : _environmentComponents_2) {
            _builder.append("\t\t\t");
            String _scheduleCall = this.envUtil.getScheduleCall(((ElementaryEnvironmentComponentInstance) inst_2));
    ...
    _builder.newLine();
    {
      Collection<SimpleChannels.Match> _allMatches = SimpleChannels.Matcher.on(this.trace.getEngine()).getAllMatches(component, null, null, null);
    ...
    _builder.newLine();
    {
      Set<BroadcastChannel> _allValuesOfbroadcastChannel_1 = BroadcastChannels.Matcher.on(this.trace.getEngine()).getAllValuesOfbroadcastChannel(component, null, null);
      for(final BroadcastChannel channel_2 : _allValuesOfbroadcastChannel_1) {
        {
          ...
          if (_not) {
            ...
            _builder.newLineIfNotEmpty();
            {
              Collection<BroadcastChannels.Match> _allMatches_1 = BroadcastChannels.Matcher.on(this.trace.getEngine()).getAllMatches(component, channel_2, null, null);
