 ...
 *   <li>{@link hu.bme.mit.gamma.environment.analysis.AnalysisComponent#getSimulationTime <em>Simulation Time</em>}</li>
 *   <li>{@link hu.bme.mit.gamma.environment.analysis.AnalysisComponent#getSimulationNumber <em>Simulation Number</em>}</li>
 *   <li>{@link hu.bme.mit.gamma.environment.analysis.AnalysisComponent#getPriorydistribution <em>Priorydistribution</em>}</li>
 *   <li>{@link hu.bme.mit.gamma.environment.analysis.AnalysisComponent#getEndcondition <em>Endcondition</em>}</li>
 *   <li>{@link hu.bme.mit.gamma.environment.analysis.AnalysisComponent#getWarmupTime <em>Warmup Time</em>}</li>
 * </ul>
 *
...
public interface AnalysisComponent extends Component {
	 ...
	 * @see hu.bme.mit.gamma.environment.analysis.AnalysisPackage#getAnalysisComponent_SimulationTime()
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.gamma.environment.analysis.AnalysisComponent#getSimulationTime <em>Simulation Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hu.bme.mit.gamma.environment.analysis.AnalysisPackage#getAnalysisComponent_SimulationNumber()
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.gamma.environment.analysis.AnalysisComponent#getSimulationNumber <em>Simulation Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hu.bme.mit.gamma.environment.analysis.AnalysisPackage#getAnalysisComponent_Endcondition()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see hu.bme.mit.gamma.environment.analysis.AnalysisPackage#getAnalysisComponent_WarmupTime()
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.gamma.environment.analysis.AnalysisComponent#getWarmupTime <em>Warmup Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
