 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.gamma.environment.analysis.ObserveCondition#getValue <em>Value</em>}</li>
...
public interface ObserveCondition extends AnalysisCondition {
	 ...
	 * @see #setValue(double)
	 * @see hu.bme.mit.gamma.environment.analysis.AnalysisPackage#getObserveCondition_Value()
	 * @model required="true"
	 * @generated
	 */
	double getValue();
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.gamma.environment.analysis.ObserveCondition#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
