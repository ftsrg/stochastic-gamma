...
public class InternalFMEDALanguageLexer extends Lexer {
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFMEDALanguage.g:4059:13: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* )
            // InternalFMEDALanguage.g:4059:15: ( '0' .. '9' )+ '.' ( '0' .. '9' )*
            {
            // InternalFMEDALanguage.g:4059:15: ( '0' .. '9' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalFMEDALanguage.g:4059:16: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            match('.'); 
            // InternalFMEDALanguage.g:4059:31: ( '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalFMEDALanguage.g:4059:32: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFMEDALanguage.g:4061:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalFMEDALanguage.g:4061:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalFMEDALanguage.g:4061:11: ( '^' )?
            int alt3=2;
            ...
            // InternalFMEDALanguage.g:4061:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFMEDALanguage.g:4063:10: ( ( '0' .. '9' )+ )
            // InternalFMEDALanguage.g:4063:12: ( '0' .. '9' )+
            {
            // InternalFMEDALanguage.g:4063:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalFMEDALanguage.g:4063:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFMEDALanguage.g:4065:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalFMEDALanguage.g:4065:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalFMEDALanguage.g:4065:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalFMEDALanguage.g:4065:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalFMEDALanguage.g:4065:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // InternalFMEDALanguage.g:4065:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalFMEDALanguage.g:4065:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalFMEDALanguage.g:4065:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalFMEDALanguage.g:4065:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // InternalFMEDALanguage.g:4065:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalFMEDALanguage.g:4065:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFMEDALanguage.g:4067:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalFMEDALanguage.g:4067:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalFMEDALanguage.g:4067:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
                ...
                switch (alt9) {
            	case 1 :
            	    // InternalFMEDALanguage.g:4067:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFMEDALanguage.g:4069:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalFMEDALanguage.g:4069:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalFMEDALanguage.g:4069:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
            ...
            // InternalFMEDALanguage.g:4069:40: ( ( '\\r' )? '\\n' )?
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalFMEDALanguage.g:4069:41: ( '\\r' )? '\\n'
                    {
                    // InternalFMEDALanguage.g:4069:41: ( '\\r' )?
                    int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFMEDALanguage.g:4071:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalFMEDALanguage.g:4071:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalFMEDALanguage.g:4071:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFMEDALanguage.g:4073:16: ( . )
            // InternalFMEDALanguage.g:4073:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA14_transitionS = {
            "\11\37\2\36\2\37\1\36\22\37\1\36\1\37\1\33\4\37\1\34\4\37\1\17\1\27\1\13\1\35\12\30\1\11\1\12\1\16\1\26\3\37\2\32\1\15\2\32\1\24\11\32\1\25\12\32\1\6\1\37\1\7\1\31\1\32\1\37\1\32\1\22\1\3\1\21\1\32\1\2\2\32\1\10\6\32\1\1\2\32\1\20\1\14\2\32\1\23\3\32\1\4\1\37\1\5\uff82\37",
            "\1\40\15\uffff\1\41",
            "\1\43",
            "\1\44",
            "",
