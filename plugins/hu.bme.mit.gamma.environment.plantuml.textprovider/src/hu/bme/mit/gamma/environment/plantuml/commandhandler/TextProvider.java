 ...
 ********************************************************************************/
package hu.bme.mit.gamma.environment.plantuml.commandhandler;
...
import hu.bme.mit.gamma.environment.plantuml.transformation.CompositeToPlantUmlTransformer;
import hu.bme.mit.gamma.environment.plantuml.transformation.InterfaceToPlantUmlTransformer;
import hu.bme.mit.gamma.environment.plantuml.transformation.StatechartToPlantUmlTransformer;
...
public class TextProvider extends AbstractDiagramIntentProvider {
	...
	private List<String> supportedExtensions = Arrays.asList("sgcd");
