...
public class PyroComponentClassGenerator {
  ...
  public CharSequence generateEventSourceClass() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("if pevent in self.rules[port] and pevent in self.calls[port]:");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("rule=self.rules[port][pevent]");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("calls=self.calls[port][pevent]");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("time=rule.calc(port+\".\"+pevent,0.0)");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("ename=port+\".\"+pevent");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("for call in calls:");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("self.simulator.events.append(Event(self,time,call,ename))");
    _builder.newLine();
    return _builder;
  }
  ...
  public CharSequence generatePeriodicEventSourceClass() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("self.simulator.events.append(Event(self,simulationtime,call,ename))");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    return _builder;
  ...
  public CharSequence generateSampleClasses(final List<EnvironmentConnections> connections) {
    ...
    _builder.newLineIfNotEmpty();
    {
      for(final ElementaryEnvironmentComponentInstance sample : samples) {
        ...
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("self.events.clear(self.name)");
        _builder.newLine();
        _builder.newLine();
        {
          ...
          for(final Event event : _outputEvents) {
            ...
            _builder.newLineIfNotEmpty();
            _builder.append("\t\t\t\t");
            _builder.append("self.events.append(Event(self,self.simulator.time,callEvent,self.port+\".");
            String _firstUpper_9 = StringExtensions.toFirstUpper(event.getName());
            ...
            _builder.append("(");
            CharSequence _generateFuncParams_4 = TransformationUtility.generateFuncParams(event);
            _builder.append(_generateFuncParams_4, "\t\t\t\t");
            _builder.append(")");
            _builder.newLineIfNotEmpty();
          }
        }
    ...
    for (final Interface i : interfaces) {
      ...
      _builder.newLine();
      {
        ...
        for(final Event event : _filter) {
          ...
          _builder.append("\t");
          _builder.append("\t\t");
          _builder.append("self.simulator.events.append(Event(self,failureTime,callEvent,self.port+\".");
          String _firstUpper_6 = StringExtensions.toFirstUpper(event.getName());
          _builder.append(_firstUpper_6, "\t\t\t");
          _builder.append("\"))");
          _builder.newLineIfNotEmpty();
  ...
  public CharSequence generateEventClass() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def __init__(self,eventSource,eventTime,eventCall,name=\"anonymous\"):");
    _builder.newLine();
    _builder.append("\t\t");
