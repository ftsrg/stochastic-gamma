...
public class JavaEntryClassGenerator {
          ...
          if (_equals) {
            ...
            _builder.newLine();
            {
              if ((a instanceof ObserveParameter)) {
                ...
                CharSequence _generateName = TransformationUtility.generateName(((ObserveParameter)a).getParameter());
            ...
            }
            {
              if ((a instanceof ParameterDistribution)) {
                ...
                _builder.append("\t");
                _builder.append("parameter=");
                CharSequence _generateName_1 = TransformationUtility.generateName(((ParameterDistribution)a).getParameter());
            ...
            }
            {
              if ((a instanceof MeanParameter)) {
                ...
                CharSequence _generateName_2 = TransformationUtility.generateName(((MeanParameter)a).getParameter());
