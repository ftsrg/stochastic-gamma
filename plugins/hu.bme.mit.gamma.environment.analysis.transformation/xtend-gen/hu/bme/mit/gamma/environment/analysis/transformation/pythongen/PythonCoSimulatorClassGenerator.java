...
public class PythonCoSimulatorClassGenerator {
  ...
  public static CharSequence generateExternSimulationTemplateClasses(final String packageName, final List<EnvironmentConnections> connections) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.newLine();
          ...
          for(final Interface i : interfaces) {
            ...
            _builder.newLine();
            {
              ...
              for(final EventDeclaration event : _events) {
                ...
                CharSequence _generateFuncParams = PythonCoSimulatorClassGenerator.generateFuncParams(event.getEvent());
                ...
                _builder.append("\",(");
                CharSequence _generateFuncParams_1 = PythonCoSimulatorClassGenerator.generateFuncParams(event.getEvent());
          ...
          for(final Port port : _outports) {
            {
              ...
              for(final Event event_1 : _map) {
                ...
                _builder.append("(");
                CharSequence _generateFuncParams_2 = PythonCoSimulatorClassGenerator.generateFuncParams(event_1);
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  for(final String outCall : _get_1) {
                    ...
                    _builder.append("(");
                    CharSequence _generateFuncParams_3 = PythonCoSimulatorClassGenerator.generateFuncParams(event_1);
