...
public class PyroSimulatorGenerator {
  public CharSequence generate(final AnalysisComponent analysis_component, final String packageName, final String basePackage) {
    CharSequence _xblockexpression = null;
    {
      ...
      PyroComponentClassGenerator compClassGenerator = new PyroComponentClassGenerator(packageName, analysis_component);
      ...
      _builder.append("# automatically generated probabilistic program");
      _builder.newLine();
      _builder.append("# generated by Gamma Composition Framework");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("time_conv=1.0 # 1000000000.0*60*60*1000");
      _builder.newLine();
      _builder.newLine();
      _builder.append("simTime=");
      String _string_1 = Double.toString(expEval.evaluateDecimal(analysismethod.getSimulationTime()));
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("EntryPoint = JClass(\'javaenv.");
      String _firstUpper = StringExtensions.toFirstUpper(analysis_component.getName());
      _builder.append(_firstUpper, "\t");
      _builder.append("EntryPoint\')");
      _builder.newLineIfNotEmpty();
      _builder.append("\t");
      _builder.append("detmodel = EntryPoint()");
      _builder.newLine();
      _builder.append("\t");
      ...
      _builder.newLine();
      String _generateClasses = distGenerator.generateClasses(analysismethod);
  ...
  public CharSequence generateImports() {
    ...
    _builder.newLine();
    _builder.append("from pyro.distributions.torch_distribution import TorchDistribution");
    _builder.newLine();
    _builder.append("from pyro.distributions.util import broadcast_shape");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("import statistics as stats");
    _builder.newLine();
    _builder.newLine();
    ...
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLine();
      {
        ...
        if (_needTimer) {
          ...
          _builder.append("\t\t");
          _builder.append("\t");
          _builder.append("stochmodel.time = stochmodel.time + float(gamma_time)/time_conv");
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("\t");
          _builder.append("detmodel.get");
          ...
          _builder.append("\t\t");
          _builder.append("\t");
          _builder.append("deltaTime = event.eventTime - stochmodel.time");
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("\t");
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("\t");
          _builder.append("if event.eventTime > simTime :");
          _builder.newLine();
          {
            if (debug) {
              _builder.append("\t\t");
          ...
          _builder.append("\t\t");
          _builder.append("\t");
          _builder.append("detmodel.timer.elapse(int(deltaTime))");
          _builder.newLine();
        } else {
          _builder.append("\t\t");
          _builder.append("# get the event with the earliest clock");
      ...
      _builder.newLine();
      {
        if (debug) {
          ...
          _builder.newLine();
          _builder.append("\t");
          _builder.append("if len(stochmodel.events) == 0:");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("\t");
          _builder.append("dprint(\'hnote over stochmodel \')");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("\t");
          _builder.append("dprint(\'no stochastic event\')");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("\t");
          _builder.append("dprint(\"endnote\")\t\t\t\t");
